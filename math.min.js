...
!(function(e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
        ? define([], t)
        : 'object' == typeof exports ? (exports.math = t()) : (e.math = t());
})(this, function() {
  return (function(e) {
    function t(n) {
    ...
    function(e, t, r) {
      ...
      (t.isNumber = function(e) {
        ...
        var n = 'auto', i = void 0;
        switch ((r &&
          (r.notation && (n = r.notation), t.isNumber(r)
            ? (i = r)
            : r.precision && (i = r.precision)), n)) {
          case 'fixed':
        ...
        var i = t.splitNumber(e),
          ...
          s = a.exponent + 1,
          u = s + (r || 0);
        return o.length < u && (o = o.concat(n(u - o.length))), s < 0 &&
          ((o = n(-s + 1).concat(o)), (s = 1)), r &&
          o.splice(s, 0, 0 === s ? '0.' : '.'), a.sign + o.join('');
        ...
        if (isNaN(e) || !isFinite(e)) return String(e);
        var a = i && void 0 !== i.lower ? i.lower : 0.001,
        ...
        f.length < r && (f = f.concat(n(r - f.length))), (f = f.concat(
          n(l - f.length + 1 + (f.length < r ? r - f.length : 0))
        )), (f = n(-l).concat(f));
        var p = l > 0 ? l : 0;
        ...
        if (n.length > t) {
          ...
          if (i[0] >= 5) {
            var a = t - 1;
            for (n[a]++; 10 === n[a]; )
              n.pop(), 0 === a && (n.unshift(0), r.exponent++, a++), a--, n[
                a
              ]++;
          }
        }
        ...
        return e.toExponential().replace(/e.*$/, '').replace(/^0\.?0*|\./, '')
          .length;
      }), (t.DBL_EPSILON =
        Number.EPSILON || 2.220446049250313e-16), (t.nearlyEqual = function(
        e,
        r,
        n
      ) {
        ...
        if (isFinite(e) && isFinite(r)) {
          var i = Math.abs(e - r);
          return (
            i < t.DBL_EPSILON || i <= Math.max(Math.abs(e), Math.abs(r)) * n
          );
        }
        return !1;
      });
    ...
    function(e, t, r) {
      ...
      function i(e, r, n, a) {
        ...
        if (((e.length = c), n < r.length - 1)) {
          var l = n + 1;
          for (o = 0; o < f; o++)
            (s = e[o]), Array.isArray(s) || ((s = [s]), (e[o] = s)), i(
              s,
              r,
              l,
              a
        ...
        for (var i in n)
          if (t.hasOwnProperty(n, i))
            if (n[i] && n[i].constructor === Object)
              void 0 === r[i] && (r[i] = {}), r[i].constructor === Object
                ? e(r[i], n[i])
                : (r[i] = n[i]);
            else {
      ...
      function n() {
        ...
        function t(e, t, n) {
          ...
          if ('function' != typeof e._compile || i(e, '_compile'))
            throw new Error(
              'Cannot compile node: unknown type "' + e.type + '"'
            );
    ...
    function(e, t, r) {
      ...
      (n.prototype = new RangeError()), (n.prototype.constructor = RangeError), (n.prototype.name =
        'DimensionError'), (n.prototype.isDimensionError = !0), (e.exports = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, r, n) {
        ...
        var s = r(4),
            ...
            i(
              {
                ...
                'Matrix, Matrix': function(e, t) {
                  ...
                  return v(r, n), 1 === r.length
                    ? 1 === n.length ? y(e, t, r[0]) : x(e, t)
                    : 1 === n.length ? b(e, t) : N(e, t);
                },
          ...
          w = function(e, t) {
            ...
            a &&
              ...
              a === l &&
              'string' == typeof a &&
              ((r = a), (d = o.find(c, [r, r])), (g = o.find(f, [r, r])));
            for (var v = [], y = 0; y < h; y++) {
          ...
          E = function(e, t) {
            ...
            a &&
              ...
              a === u &&
              'string' == typeof a &&
              ((r = a), (h = o.find(c, [r, r])), (d = o.find(f, [r, r])));
            for (var g = [], v = 0; v < l; v++) {
          ...
          A = function(e, t) {
            ...
            i &&
              ...
              i === h &&
              'string' == typeof i &&
              ((m = i), (y = o.find(c, [m, m])), (x = o.find(f, [
                m,
                m,
              ])), (w = o.find(l, [m, m])), (b = o.convert(0, m)));
            for (
              var N = [],
                E = [],
                M = [],
          ...
          O = function(e, t) {
            ...
            a &&
              ...
              a === p &&
              'string' == typeof a &&
              ((s = a), (x = o.find(c, [s, s])), (w = o.find(f, [
                s,
                s,
              ])), (b = o.find(l, [s, s])), (N = o.convert(0, s)));
            var E = [], M = [];
            y[0] = 0;
            for (var A = 0; A < m; A++) {
              var O = u[A];
          ...
          T = function(e, t) {
            ...
            a &&
              ...
              a === p &&
              'string' == typeof a &&
              ((s = a), (v = o.find(c, [s, s])), (y = o.find(f, [
                s,
                s,
              ])), (x = o.find(l, [s, s])), (w = o.convert(0, s)));
            for (
              var b = [],
                N = [],
                E = [],
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, s, u) {
        ...
        return (c.prototype.eval = function(e) {
          ...
          'Node'), (c.prototype.isNode = !0), (c.prototype.comment =
      ...
      (t.name = 'Node'), (t.path =
        'expression.node'), (t.math = !0), (t.factory = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, r, n) {
      ...
      function n(e, t, n, i) {
        var a = n(r(10)),
          ...
          s = function(e, t, r, n) {
            ...
            'string' == typeof l &&
              ((p = l), (d = i.find(a, [p, p])), (g = i.convert(
                0,
                p
              )), (t = i.convert(t, p)), (v = i.find(r, [p, p])));
            for (
              var y = [],
                x = [],
                w = [],
      ...
      function n(e, t, r, n) {
        var i = e.DenseMatrix,
          a = function(e, t, r, a) {
            ...
            'string' == typeof f &&
              ((l = f), (t = n.convert(t, l)), (m = n.find(r, [l, l])));
            for (
              var d = [],
                g = new i({ data: d, size: [p, h], datatype: l }),
                v = [],
                y = [],
                x = 0;
              x < h;
        ...
        var a = n(r(22)),
          o = i('divide', {
            ...
            'Unit, number | Fraction | BigNumber': function(e, t) {
              var r = e.clone();
              return (r.value = o(
                null === r.value ? r._normalize(1) : r.value,
                t
              )), r;
            },
      ...
      function n(e, t, n, a) {
        var o = n(r(10)),
          ...
          u = function(e, t, r, n) {
            ...
            'string' == typeof f &&
              f === d &&
              ((g = f), (x = a.find(o, [g, g])), (w = a.convert(
                0,
                g
              )), (b = a.find(r, [g, g])));
    ...
    function(e, t, r) {
      'use strict';
      (t.array = r(3)), (t.boolean = r(509)), (t.function = r(
        37
      )), (t.number = r(2)), (t.object = r(5)), (t.string = r(
        11
      )), (t.types = r(63)), (t.emitter = r(139));
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, r, n) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, u, c) {
        ...
        function l(e, t, r) {
          ...
          return o(r, e.name)
            ...
            : e.name in t.math
                ? '(' +
                    n +
                    ' in scope ? getSafeProperty(scope, ' +
                    n +
                    ') : getSafeProperty(math, ' +
                    n +
                    '))'
                : '(' +
                    n +
        ...
        var h = n(r(7)).register,
          ...
          d = n(r(137));
        return (f.prototype = new m()), (f.prototype.type =
          'SymbolNode'), (f.prototype.isSymbolNode = !0), h(
          f.prototype.type,
          l
        ), (f.prototype.forEach = function(e) {}), (f.prototype.map = function(
          e
        ) {
          return this.clone();
          ...
          var t = !1;
          'undefined' == typeof c[this.name] &&
            d.isValuelessUnit(this.name) &&
            (t = !0);
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        function h() {
          ...
          if ('\n' == ve && !we)
            return (xe = fe.DELIMITER), (ye = ve), void c();
          var e = ve + l(), t = e + p();
          if (3 == t.length && le[t])
          ...
          if (!s.isDigitDot(ve)) {
            if (s.isAlpha(ve, f(), l())) {
              for (; s.isAlpha(ve, f(), l()) || s.isDigit(ve); )
                (ye += ve), c();
              return void (xe = pe.hasOwnProperty(ye)
                ? fe.DELIMITER
                : fe.SYMBOL);
            }
          ...
          if (((xe = fe.NUMBER), '.' == ve))
            (ye += ve), c(), s.isDigit(ve) || (xe = fe.DELIMITER);
          else {
            for (; s.isDigit(ve); )
              (ye += ve), c();
          ...
          if (((e = l()), 'E' == ve || 'e' == ve))
            if (s.isDigit(e) || '-' == e || '+' == e) {
              if (
                ((ye += ve), c(), ('+' != ve && '-' != ve) ||
                  ((ye += ve), c()), !s.isDigit(ve))
              )
                throw W('Digit expected, got "' + ve + '"');
              for (; s.isDigit(ve); )
                (ye += ve), c();
              if (s.isDecimalMark(ve, l()))
                throw W('Digit expected, got "' + ve + '"');
            } else if ('.' == e)
              throw (c(), W('Digit expected, got "' + ve + '"'));
        }
        function m() {
          do
            h();
        ...
        function v() {
          ...
          var e = y();
          if ('' != ye)
            throw xe == fe.DELIMITER
              ? Y('Unexpected operator ' + ye)
              : W('Unexpected part "' + ye + '"');
          return e;
        }
        function y() {
          var e, t, r = [];
          for (
            ...
            0 == r.length &&
              e &&
              ((t = ';' != ye), r.push({ node: e, visible: t })), h(), '\n' !=
              ye &&
              ';' != ye &&
              '' != ye &&
              ((e = x()), (e.comment = de), (t = ';' != ye), r.push({
                node: e,
                visible: t,
              }));
          return r.length > 0
            ? new K(r)
            : (e ||
                ((e = new te('undefined', 'undefined')), (e.comment = de)), e);
        }
        function x() {
          var e, t, r, n, i = w();
          if ('=' == ye) {
            if (i && i.isSymbolNode)
              return (e = i.name), m(), (r = x()), new Q(new ce(e), r);
            if (i && i.isAccessorNode)
              return m(), (r = x()), new Q(i.object, i.index, r);
            if (
              i &&
              i.isFunctionNode &&
              ((n = !0), (t = []), (e = i.name), i.args.forEach(function(e, r) {
                e && e.isSymbolNode ? (t[r] = e.name) : (n = !1);
              }), n)
            )
              return m(), (r = x()), new re(e, t, r);
        ...
        function S() {
          var e, t, r, n, i;
          for ((e = C()), (t = { to: 'to', in: 'to' }); t.hasOwnProperty(ye); )
            (r = ye), (n = t[r]), m(), 'in' === r && '' === ye
              ? (e = new ae('*', 'multiply', [e, new ce('in')], !0))
              : ((i = [e, C()]), (e = new ae(r, n, i)));
          return e;
        }
        function C() {
          var e, t = [];
          if (
            ((e = ':' == ye ? new te('1', 'number') : z()), ':' == ye &&
              be !== we)
          ) {
        ...
        function k() {
          ...
          for (
            ...
            if (r.hasOwnProperty(ye))
              (n = ye), (i = r[n]), m(), (t = B()), (e = new ae(n, i, [e, t]));
            else {
              if (
                !(xe == fe.SYMBOL || ('in' == ye && e && e.isConstantNode)) &&
                (xe != fe.NUMBER ||
                  t.isConstantNode ||
                  (t.isOperatorNode && '!' !== t.op)) &&
                '(' != ye
              )
                break;
        ...
        function B() {
          ...
          return n.hasOwnProperty(ye)
            ? ((r = n[ye]), (e = ye), m(), (t = [B()]), new ae(e, r, t))
            : P();
        }
        function P() {
          var e, t, r, n;
          return (e = I()), ('^' != ye && '.^' != ye) ||
            ((t = ye), (r = '^' == t ? 'pow' : 'dotPow'), m(), (n = [
              e,
              B(),
            ]), (e = new ae(t, r, n))), e;
        }
        function I() {
          var e, t, r, n, i;
          for (
            (e = R()), (t = { '!': 'factorial', "'": 'transpose' });
            t.hasOwnProperty(ye);

          )
            (r = ye), (n = t[r]), h(), (i = [e]), (e = new ae(r, n, i)), (e = q(
              e
            ));
          return e;
        }
        ...
        function U() {
          var e, t;
          return xe == fe.SYMBOL || (xe == fe.DELIMITER && ye in pe)
            ? ((t = ye), h(), (e = new ce(t)), (e = q(e)))
            : L();
        }
        function q(e, t) {
          for (
            ...
            if (((r = []), '(' == ye)) {
              if (!(e.isSymbolNode || e.isAccessorNode || e.isFunctionNode))
                return e;
              if ((d(), h(), ')' != ye))
                for (r.push(x()); ',' == ye; )
                  h(), r.push(x());
        ...
        return (s.isAlpha = function(e, t, r) {
          return (
            s.isValidLatinOrGreek(e) ||
            s.isValidMathSymbol(e, r) ||
            s.isValidMathSymbol(t, e)
          );
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(r, n) {
          ...
          return (r * r < 1 && n === 1 / 0) || (r * r > 1 && n === -(1 / 0))
            ? 0
            : t.predictable &&
                ((r < -1 && n === 1 / 0) || (r > -1 && r < 0 && n === -(1 / 0)))
                ? NaN
                : i(n) || r >= 0 || t.predictable
                    ? Math.pow(r, n)
                    : new e.Complex(r, 0).pow(n, 0);
        }
        function u(e, t) {
          if (!i(t) || t < 0)
            throw new TypeError(
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, i) {
        ...
        (this.fn = e), (this.count = t), (this.min = r), (this.max = i), (this.message =
      ...
      (n.prototype = new Error()), (n.prototype.constructor = Error), (n.prototype.name =
        'ArgumentsError'), (n.prototype.isArgumentsError = !0), (e.exports = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, r) {
        ...
        (this.index = e), arguments.length < 3
          ? ((this.min = 0), (this.max = t))
          : ((this.min = t), (this.max = r)), void 0 !== this.min &&
          this.index < this.min
          ? (this.message =
      ...
      (n.prototype = new RangeError()), (n.prototype.constructor = RangeError), (n.prototype.name =
        'IndexError'), (n.prototype.isIndexError = !0), (e.exports = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, n, o) {
          ...
          switch (e.valueType) {
            case 'number':
              return 'BigNumber' === t.number
                ? 'math.bignumber(' + a(e.value) + ')'
                : 'Fraction' === t.number
                    ? 'math.fraction(' + a(e.value) + ')'
                    : (c(e.value), e.value.replace(/^(0*)[0-9]/, function(
                        e,
                        t
                      ) {
            ...
            default:
              throw new TypeError(
                'Unsupported type of constant "' + e.valueType + '"'
              );
          }
        }
        function c(e) {
        ...
        var f = n(r(7)).register,
          ...
          p = { number: !0, string: !0, boolean: !0, undefined: !0, null: !0 };
        return (s.prototype = new l()), (s.prototype.type =
          'ConstantNode'), (s.prototype.isConstantNode = !0), f(
          s.prototype.type,
          u
        ), (s.prototype.forEach = function(e) {}), (s.prototype.map = function(
          e
        ) {
          return this.clone();
          ...
          switch (this.valueType) {
            case 'string':
              return '\\mathtt{' + a(r) + '}';
            case 'number':
              return (t = r.toLowerCase().indexOf('e')), t !== -1
                ? r.substring(0, t) + '\\cdot10^{' + r.substring(t + 1) + '}'
                : r;
            default:
              return r;
          }
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, p, h) {
        function m(e, t) {
          ...
          if (('string' == typeof e && (e = new b(e)), !e || !e.isNode))
          ...
          (this.fn = e), (this.args = t || []), Object.defineProperty(
            this,
            'name',
            {
              get: function() {
        ...
        function d(e, t, r) {
          ...
          return (n = l(t)), (t[n] = e.args), '(function () {var fn = ' +
            i +
        ...
        var y = n(r(7)).register,
          ...
          w = n(r(13)),
          b = n(r(27));
        (m.prototype = new w()), (m.prototype.type =
          'FunctionNode'), (m.prototype.isFunctionNode = !0), y(
          m.prototype.type,
          d
        ...
        (m.prototype.toString = function(e) {
          ...
          return e &&
            ...
            s(e.handler, r) &&
            (t = e.handler[r](this, e)), 'undefined' != typeof t
            ? t
            : N.call(this, e);
        ...
        return (m.prototype.toTex = function(e) {
          ...
          return e &&
            'object' == typeof e.handler &&
            s(e.handler, this.name) &&
            (t = e.handler[this.name](this, e)), 'undefined' != typeof t
            ? t
            : E.call(this, e);
          ...
          !h[this.name] ||
            ('function' != typeof h[this.name].toTex &&
              'object' != typeof h[this.name].toTex &&
              'string' != typeof h[this.name].toTex) ||
            (t = h[this.name].toTex);
          var n;
          switch (typeof t) {
            case 'function':
      ...
      function n(e, t, n, o) {
        var s = n(r(0)),
          ...
          h = o('compare', {
            ...
            'BigNumber, BigNumber': function(r, n) {
              return r.eq(n) || a(r, n, t.epsilon)
                ? new e.BigNumber(0)
                : new e.BigNumber(r.cmp(n));
            },
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, f, l) {
        function p(e, t, r, n) {
          ...
          (this.implicit =
            n === !0), (this.op = e), (this.fn = t), (this.args = r || []);
        }
        function h(e, t, r) {
          if (!(e instanceof p)) throw new TypeError('No valid OperatorNode');
          if ('string' != typeof e.fn || !u(t.math, e.fn))
            throw t.math[e.fn]
              ? new Error('No access to function "' + e.fn + '"')
              : new Error(
                  'Function ' + e.fn + ' missing in provided namespace "math"'
                );
        ...
        function m(e, t, r, n) {
          ...
          if (1 === r.length) {
            ...
            if (n && null !== s) {
              ...
              if (
                ('keep' === t
                  ? ((u = r[0].getIdentifier()), (f = e.getIdentifier()))
                  : ((u = r[0]
                      .getContent()
                      .getIdentifier()), (f = e
                      .getContent()
                      .getIdentifier())), c.properties[i][f].latexLeftParens ===
                  !1)
              )
                return [!1];
          ...
          if (2 === r.length) {
            ...
            if (
              ((m =
                null !== d && ((d === i && 'left' === a && !g) || d < i)), n)
            ) {
              var f, v, y;
              'keep' === t
                ? ((f = e.getIdentifier()), (v = e.args[0].getIdentifier()), (y = e.args[1].getIdentifier()))
                : ((f = e
                    .getContent()
                    .getIdentifier()), (v = e.args[0]
                    .getContent()
                    .getIdentifier()), (y = e.args[1]
                    .getContent()
                    .getIdentifier())), null !== p &&
                (c.properties[i][f].latexLeftParens === !1 && (l = !1), c
                  .properties[p][v].latexParens === !1 && (l = !1)), null !==
                d &&
                (c.properties[i][f].latexRightParens === !1 && (m = !1), c
                  .properties[d][y].latexParens === !1 && (m = !1));
            }
            return [l, m];
          }
          if (
        ...
        return (p.prototype = new v()), (p.prototype.type =
          'OperatorNode'), (p.prototype.isOperatorNode = !0), d(
          p.prototype.type,
          h
          ...
          if (1 === n.length) {
            ...
            return i[0] && (o = '(' + o + ')'), 'right' === a
              ? this.op + o
              : 'left' === a ? o + this.op : o + this.op;
          }
          if (2 == n.length) {
          ...
          if (((o = 'undefined' == typeof o ? this.op : o), 1 === n.length)) {
            ...
            return a[0] && (u = '\\left(' + u + '\\right)'), 'right' === s
              ? o + u
              : 'left' === s ? u + o : u + o;
          }
          if (2 === n.length) {
            ...
            switch (((d = 'keep' === t
              ? f.getIdentifier()
              : f.getContent().getIdentifier()), this.getIdentifier())) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (a.prototype = new c()), (a.prototype.type =
          'ParenthesisNode'), (a.prototype.isParenthesisNode = !0), s(
          a.prototype.type,
          o
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        function u(t, r, n) {
          var o = t && t.isBigNumber === !0
            ? e.BigNumber
            : r && r.isBigNumber === !0 ? e.BigNumber : null;
          if (
            (t && t.isBigNumber === !0 && (t = t.toNumber()), r &&
              r.isBigNumber === !0 &&
              (r = r.toNumber()), !a(t) || t < 1)
          )
            throw new Error(
      ...
      function n(e, t, n, a) {
        var o = n(r(10)),
          ...
          u = function(e, t, r) {
            ...
            'string' == typeof l &&
              l === g &&
              ((v = l), (w = a.find(o, [v, v])), (b = a.convert(
                0,
                v
              )), (N = a.find(r, [v, v])));
            var E,
      ...
      function n(e, t, n, o) {
        var s = n(r(10)),
          ...
          c = function(e, t, r) {
            ...
            'string' == typeof f &&
              f === h &&
              ((m = f), (v = o.find(s, [m, m])), (y = o.convert(
                0,
                m
              )), (x = o.find(r, [m, m])));
            for (
                  ...
                  : e instanceof Number
                      ...
                      : e instanceof String
                          ...
                          : Array.isArray(e)
                              ...
                              : e instanceof Date
                                  ? 'Date'
                                  : e instanceof RegExp ? 'RegExp' : 'Object'
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(e) {
          ...
          if (
            ((this.items = e || []), !Array.isArray(this.items) ||
        ...
        return (s.prototype = new l()), (s.prototype.type =
          'ArrayNode'), (s.prototype.isArrayNode = !0), c(
          s.prototype.type,
          u
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(e, t) {
          ...
          if (
            ((this.dimensions = e), (this.dotNotation = t || !1), !h(e) ||
              !e.every(function(e) {
                return e && e.isNode;
              }))
          )
        ...
        function u(e, t, r) {
          ...
          var o = i(e.dimensions, function(e, r) {
            return e && e.isRangeNode
              ? e.needsEnd()
                  ? ((n.end = 'end'), '(function () {var end = size[' +
                      r +
                      ']; return range(' +
                      f(e.start, t, n) +
                      ', ' +
        ...
        var c = n(r(7)).register,
          ...
          h = Array.isArray;
        return (s.prototype = new l()), (s.prototype.type =
          'IndexNode'), (s.prototype.isIndexNode = !0), c(
          s.prototype.type,
          u
        ), (s.prototype.forEach = function(e) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        var c = n(r(7)).register, f = n(r(7)).compile, l = n(r(13));
        return (o.prototype = new l()), (o.prototype.type =
          'RangeNode'), (o.prototype.isRangeNode = !0), (o.prototype.needsEnd = function() {
              ...
              pickRandom: s({
                ...
                'Array, number | Array': function(e, t) {
                  ...
                  if (Array.isArray(t)) i = t;
                    ...
                    if (!o(t))
                      throw new TypeError(
                        'Invalid argument in function pickRandom'
                      );
                    n = t;
                  }
                  return r(e, n, i);
              ...
              c = function(e, t, r, n) {
                ...
                if (((e = e.slice(0)), e.length > 1))
                  for (var a = 0, i = e.shift(); a < i; a++)
                    o.push(c(e, t, r, n));
                else for (var a = 0, i = e.shift(); a < i; a++) o.push(n(t, r));
                return o;
              };
            return t;
          })(r);
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (i.prototype.type =
          'Matrix'), (i.prototype.isMatrix = !0), (i.storage = function(e) {
      ...
      function n(e) {
        ...
        for (var f = [0], n = 0; n < u.length; ) {
          ...
          for (var o = 0; o < f.length; ++o)
            f[o] > 1 &&
              (null == f[o + 1] && (f[o + 1] = 0), (f[o + 1] += f[o] >> 1), (f[
                o
              ] &= 1));
        }
        return f.reverse();
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o, s) {
        ...
        var c = n(r(30));
        return (u.prototype.type =
          'Parser'), (u.prototype.isParser = !0), (u.prototype.parse = function(
          e
        ) {
          throw new Error(
      ...
      (t.name = 'Parser'), (t.path =
        'expression'), (t.factory = n), (t.math = !0);
    },
    function(e, t) {
      e.exports = {
        name: 'e',
    ...
    function(e, t, r) {
      function n(e, t, n, i) {
        var a = {};
        return (a.bignumber = r(164)), (a.boolean = r(165)), (a.complex = r(
          166
        )), (a.createUnit = r(167)), (a.fraction = r(168)), (a.index = r(
          169
        )), (a.matrix = r(170)), (a.number = r(171)), (a.sparse = r(
          172
        )), (a.splitUnit = r(173)), (a.string = r(174)), (a.unit = r(
          175
        )), (a.e = r(82)), (a.E = r(82)), (a.false = r(157)), (a.i = r(
          158
        )), (a.Infinity = r(149)), (a.LN2 = r(151)), (a.LN10 = r(
          150
        )), (a.LOG2E = r(153)), (a.LOG10E = r(152)), (a.NaN = r(
          154
        )), (a.null = r(159)), (a.pi = r(83)), (a.PI = r(83)), (a.phi = r(
          160
        )), (a.SQRT1_2 = r(155)), (a.SQRT2 = r(156)), (a.tau = r(
          161
        )), (a.true = r(162)), (a.version = r(163)), (a.speedOfLight = {
        ...
        }), (a.derivative = r(179)), (a.lsolve = r(180)), (a.lup = r(
          181
        )), (a.lusolve = r(182)), (a.simplify = r(184)), (a.slu = r(
          185
        )), (a.usolve = r(186)), (a.qr = r(183)), (a.abs = r(187)), (a.add = r(
          188
        )), (a.cbrt = r(189)), (a.ceil = r(190)), (a.cube = r(
          191
        )), (a.divide = r(192)), (a.dotDivide = r(193)), (a.dotMultiply = r(
          194
        )), (a.dotPow = r(195)), (a.exp = r(196)), (a.fix = r(
          197
        )), (a.floor = r(198)), (a.gcd = r(199)), (a.hypot = r(
          200
        )), (a.lcm = r(201)), (a.log = r(202)), (a.log10 = r(203)), (a.mod = r(
          204
        )), (a.multiply = r(205)), (a.norm = r(206)), (a.nthRoot = r(
          207
        )), (a.pow = r(208)), (a.round = r(209)), (a.sign = r(
          210
        )), (a.sqrt = r(211)), (a.square = r(212)), (a.subtract = r(
          213
        )), (a.unaryMinus = r(214)), (a.unaryPlus = r(215)), (a.xgcd = r(
          216
        )), (a.bitAnd = r(217)), (a.bitNot = r(218)), (a.bitOr = r(
          219
        )), (a.bitXor = r(220)), (a.leftShift = r(221)), (a.rightArithShift = r(
          222
        )), (a.rightLogShift = r(223)), (a.bellNumbers = r(
          224
        )), (a.catalan = r(225)), (a.composition = r(226)), (a.stirlingS2 = r(
          227
        )), (a.config = r(176)), (a.import = r(177)), (a.typed = r(
          178
        )), (a.arg = r(228)), (a.conj = r(229)), (a.re = r(231)), (a.im = r(
          230
        )), (a.eval = r(232)), (a.help = r(233)), (a.distance = r(
          234
        )), (a.intersect = r(235)), (a.and = r(236)), (a.not = r(
          237
        )), (a.or = r(238)), (a.xor = r(239)), (a.concat = r(
          240
        )), (a.cross = r(241)), (a.det = r(242)), (a.diag = r(243)), (a.dot = r(
          244
        )), (a.eye = r(245)), (a.filter = r(246)), (a.flatten = r(
          247
        )), (a.forEach = r(248)), (a.inv = r(249)), (a.kron = r(
          250
        )), (a.map = r(251)), (a.ones = r(252)), (a.partitionSelect = r(
          253
        )), (a.range = r(254)), (a.resize = r(256)), (a.reshape = r(
          255
        )), (a.size = r(257)), (a.sort = r(258)), (a.squeeze = r(
          259
        )), (a.subset = r(260)), (a.trace = r(261)), (a.transpose = r(
          262
        )), (a.zeros = r(263)), (a.combinations = r(264)), (a.factorial = r(
          265
        )), (a.gamma = r(266)), (a.kldivergence = r(267)), (a.multinomial = r(
          268
        )), (a.permutations = r(269)), (a.pickRandom = r(270)), (a.random = r(
          271
        )), (a.randomInt = r(272)), (a.compare = r(273)), (a.deepEqual = r(
          274
        )), (a.equal = r(275)), (a.larger = r(276)), (a.largerEq = r(
          277
        )), (a.smaller = r(278)), (a.smallerEq = r(279)), (a.unequal = r(
          280
        )), (a.erf = r(281)), (a.mad = r(282)), (a.max = r(283)), (a.mean = r(
          284
        )), (a.median = r(285)), (a.min = r(286)), (a.mode = r(
          287
        )), (a.prod = r(288)), (a.quantileSeq = r(289)), (a.std = r(
          290
        )), (a.sum = r(291)), (a.var = r(292)), (a.acos = r(293)), (a.acosh = r(
          294
        )), (a.acot = r(295)), (a.acoth = r(296)), (a.acsc = r(
          297
        )), (a.acsch = r(298)), (a.asec = r(299)), (a.asech = r(
          300
        )), (a.asin = r(301)), (a.asinh = r(302)), (a.atan = r(
          303
        )), (a.atanh = r(305)), (a.atan2 = r(304)), (a.cos = r(
          306
        )), (a.cosh = r(307)), (a.cot = r(308)), (a.coth = r(309)), (a.csc = r(
          310
        )), (a.csch = r(311)), (a.sec = r(312)), (a.sech = r(313)), (a.sin = r(
          314
        )), (a.sinh = r(315)), (a.tan = r(316)), (a.tanh = r(317)), (a.to = r(
          318
        )), (a.clone = r(319)), (a.format = r(320)), (a.isNaN = r(
          322
        )), (a.isInteger = r(321)), (a.isNegative = r(323)), (a.isNumeric = r(
          324
        )), (a.isPositive = r(325)), (a.isPrime = r(326)), (a.isZero = r(
          327
        )), (a.typeof = r(328)), a;
      }
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(e, t) {
          ...
          (this.object =
            e || null), (this.index = t), Object.defineProperty(this, 'name', {
            get: function() {
              return this.index
        ...
        var f = n(r(7)).register,
          ...
          p = n(r(13)),
          h = (n(r(66)), n(r(92)));
        return (s.prototype = new p()), (s.prototype.type =
          'AccessorNode'), (s.prototype.isAccessorNode = !0), f(
          s.prototype.type,
          u
        ), (s.prototype.forEach = function(e) {
          ...
          return c(this.object) && (t = '(' + t + ')'), t +
            this.index.toString(e);
        }), (s.prototype._toTex = function(e) {
          var t = this.object.toTex(e);
          return c(this.object) && (t = '\\left(' + t + '\\right)'), t +
            this.index.toTex(e);
        }), s;
      }
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, s) {
        function u(e, t, r) {
          ...
          if (
            ((this.object = e), (this.index = r ? t : null), (this.value = r
              ? r
              : t), !e || (!e.isSymbolNode && !e.isAccessorNode))
          )
            throw new TypeError(
        ...
        function c(e, t, r) {
          ...
          if (e.index) {
            ...
            if (e.object.isSymbolNode)
              return (n = e.index.needsSize()
            ...
            if (e.object.index.isObjectProperty()) {
              ...
              return (
                '(function () {  var parent = ' +
                g +
                ';  var object = getSafeProperty(parent, ' +
                v +
                ');  var value = ' +
                f +
                ';' +
                n +
                '  setSafeProperty(parent, ' +
                v +
                ', assign(object, ' +
                c +
                ', value));  return value;})()'
            ...
            var y = e.object.index.needsSize()
        ...
        var l = n(r(7)).register,
          ...
          d = n(r(92)),
          g = (r(64), r(47));
        return (u.prototype = new h()), (u.prototype.type =
          'AssignmentNode'), (u.prototype.isAssignmentNode = !0), l(
          u.prototype.type,
          c
        ), (u.prototype.forEach = function(e) {
          e(this.object, 'object', this), this.index &&
            e(this.index, 'index', this), e(this.value, 'value', this);
          ...
          return f(this, e && e.parenthesis) && (n = '(' + n + ')'), t +
            r +
            ' = ' +
            n;
          ...
          return f(this, e && e.parenthesis) &&
            (n = '\\left(' + n + '\\right)'), t + r + ':=' + n;
        }), u;
      }
      var i = (r(4), r(11).stringify),
        a = r(17).getSafeProperty,
        o = r(17).setSafeProperty;
      (t.name = 'AssignmentNode'), (t.path =
        'expression.node'), (t.factory = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, n, o) {
        ...
        var c = n(r(7)).register,
          ...
          p = n(r(136));
        return (s.prototype = new l()), (s.prototype.type =
          'BlockNode'), (s.prototype.isBlockNode = !0), c(
          s.prototype.type,
          u
        ), (s.prototype.forEach = function(e) {
      ...
      function n(e, t, n, a) {
        ...
        function s(e, t, r) {
          ...
          return (t.testCondition = function(e) {
            ...
            throw new TypeError(
              'Unsupported type of condition "' + t.math.typeof(e) + '"'
            );
          }), 'testCondition(' +
            c(e.condition, t, r) +
            ') ? ( ' +
        ...
        return (o.prototype = new f()), (o.prototype.type =
          'ConditionalNode'), (o.prototype.isConditionalNode = !0), u(
          o.prototype.type,
          s
        ), (o.prototype.forEach = function(e) {
          e(this.condition, 'condition', this), e(
            this.trueExpr,
            'trueExpr',
            this
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, p) {
        ...
        return (h.prototype = new y()), (h.prototype.type =
          'FunctionAssignmentNode'), (h.prototype.isFunctionAssignmentNode = !0), g(
          h.prototype.type,
          m
          ...
          var t = e && e.parenthesis ? e.parenthesis : 'keep',
            r = this.expr.toTex(e);
          return d(this, t) && (r = '\\left(' + r + '\\right)'), '\\mathrm{' +
            this.name +
            '}\\left(' +
            this.params.map(u.toSymbol).join(',') +
            '\\right):=' +
            r;
        }), h;
      }
      var i = r(64),
        ...
        l = r(93);
      (t.name = 'FunctionAssignmentNode'), (t.path =
        'expression.node'), (t.factory = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, n, s) {
        ...
        return (u.prototype = new p()), (u.prototype.type =
          'ObjectNode'), (u.prototype.isObjectNode = !0), f(
          u.prototype.type,
          c
        ), (u.prototype.forEach = function(e) {
          for (var t in this.properties)
            this.properties.hasOwnProperty(t) &&
              e(this.properties[t], 'properties[' + i(t) + ']', this);
        }), (u.prototype.map = function(e) {
          var t = {};
          for (var r in this.properties)
            this.properties.hasOwnProperty(r) &&
              (t[r] = this._ifNode(
                e(this.properties[r], 'properties[' + i(r) + ']', this)
              ));
          return new u(t);
        }), (u.prototype.clone = function() {
          var e = {};
          ...
          for (var r in this.properties)
            this.properties.hasOwnProperty(r) &&
              t.push(i(r) + ': ' + this.properties[r].toString(e));
          return '{' + t.join(', ') + '}';
        }), (u.prototype._toTex = function(e) {
          var t = [];
          for (var r in this.properties)
        ...
        var o = n(r(0)),
          ...
          x = function(e) {
            ...
            for (r = 0; r < o; r++) {
              ...
              if (
                (r !== M &&
                  ((b[r] = [b[M], (b[M] = b[r])][0]), g._swapRows(r, M, d)), r <
                  i)
              )
                for (t = r + 1; t < i; t++) {
                  var S = d[t][r];
            ...
            for (r = 0; r < o; r++)
              for (t = 0; t < i; t++)
                0 === r && (t < o && (x[t] = []), (v[t] = [])), t < r
                  ? (t < o && (x[t][r] = d[t][r]), r < i && (v[t][r] = 0))
                  : t !== r
                      ? (t < o && (x[t][r] = 0), r < i && (v[t][r] = d[t][r]))
                      : (t < o && (x[t][r] = d[t][r]), r < i && (v[t][r] = 1));
          ...
          w = function(e) {
            ...
            for (r = 0; r < a; r++) {
              var S = new v();
              r < i && (w.push(y.length), y.push(1), x.push(r)), M.push(
                N.length
              );
              var C = g[r], z = g[r + 1];
              for (n = C; n < z; n++)
              ...
              S.forEach(r + 1, i - 1, function(e, t) {
                ...
                (d._swapRows(r, k, b[1], y, x, w), d._swapRows(
                  r,
                  k,
                  A[1],
                  N,
                  E,
                  M
                ), S.swap(r, k), _(r, k)), S.forEach(0, i - 1, function(e, t) {
                e <= r
                  ? (N.push(t), E.push(e))
                  : ((t = c(t, B)), h(t, 0) || (y.push(t), x.push(e)));
              });
            }
      ...
      function n(e, t, n, i, a) {
        ...
        function s(e) {
          for (var t = [], r = 0; r < e.length; r++) {
            ...
            switch (a) {
              ...
              case 'object':
                if (
                  ((n = { l: o(d(i.l)), r: o(d(i.r)) }), i.context &&
                    (n.evaluate = i.context), i.evaluate &&
                    (n.evaluate = d(i.evaluate)), n.l.isOperatorNode && M(n.l))
                ) {
                  var c = _(n.l), f = u();
                  (n.expanded = {}), (n.expanded.l = c([n.l.clone(), f])), A(
                    n.expanded.l
                  ), O(n.expanded.l), (n.expanded.r = c([n.r, f]));
                }
                break;
              case 'function':
                n = i;
        ...
        function c(e, t) {
          ...
          if (E(e, t))
            for (var o = 0; o < e.args.length; o++)
              (n = e.args.slice(0)), n.splice(o, 1), (r = 1 === n.length
                ? n[0]
                : a(n)), i.push(a([e.args[o], r]));
          else
            (n = e.args.slice(1)), (r = 1 === n.length ? n[0] : a(n)), i.push(
              a([e.args[0], r])
            );
          return i;
        }
        function f(e, t) {
          ...
          for (var n in e.placeholders)
            if (
              ((r.placeholders[n] =
                e.placeholders[n]), t.placeholders.hasOwnProperty(n) &&
                !m(e.placeholders[n], t.placeholders[n]))
            )
              return null;
        ...
        function h(e, t, r) {
          ...
          if (
            ...
            if ((1 !== t.args.length || 1 !== e.args.length) && M(t) && !r) {
              ...
              if (e.args.length > 2)
                throw Error(
                  'Unexpected non-binary associative function: ' + e.toString()
                );
              return [];
            }
        ...
        var d = n(r(30)),
          ...
          S = i('simplify', {
            ...
            'Node, Array': function(e, t) {
              t = s(t);
              for (
                var r = o(e), n = {}, i = r.toString({ parenthesis: 'all' });
                !n[i];
          ...
          k = i('applyRule', {
            'Node, Object': function(e, t) {
              ...
              if (r instanceof y || r instanceof v) {
                ...
                r instanceof x && r.content && (r.content = k(r.content, t));
              var i = t.r, a = h(t.l, r)[0];
              return !a &&
                t.expanded &&
                ((i = t.expanded.r), (a = h(t.expanded.l, r)[0])), a &&
                ((r = i.clone()), (r = r.transform(function(e, t, r) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n, i) {
        function a(e, t) {
          ...
          var r = e.fn.toString();
          return t && t.hasOwnProperty(r) && t[r].hasOwnProperty('commutative')
            ? t[r].commutative
            : d[r] || !1;
        }
        function o(e, t) {
          if (!e.args || e.args.length <= 1) return !0;
          var r = e.fn.toString();
          return t && t.hasOwnProperty(r) && t[r].hasOwnProperty('associative')
            ? t[r].associative
            : g[r] || !1;
        }
        function s(e) {
          ...
          p = f('concat', {
            '...Array | Matrix | number | BigNumber': function(e) {
              ...
              for (t = 0; t < n; t++) {
                var m = e[t];
                if (
                  (m && m.isMatrix === !0 && (p = !0), 'number' == typeof m ||
                    (m && m.isBigNumber === !0))
                ) {
                  if (t !== n - 1)
                    throw new Error(
                  ...
                  if (
                    ((h[t] = d), (r = f), (f = g.length - 1), t > 0 && f != r)
                  )
                    throw new c(r + 1, f + 1);
                }
              }
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        function s(e, t, r) {
          var n = [], i = e;
          if (r > 0) for (; i < t; ) n.push(i), (i += r);
          else if (r < 0) for (; i > t; ) n.push(i), (i += r);
          return n;
        }
        function u(e, t, r) {
          var n = [], i = e;
        ...
        var f = n(r(12)),
          ...
          p = u('gamma', {
            number: function(e) {
              ...
              if (e < 0.5) return Math.PI / (Math.sin(Math.PI * e) * p(1 - e));
              ...
              for (var h = 1; h < s.length; ++h)
                r += s[h] / (e + h);
              return (t = e + o + 0.5), Math.sqrt(2 * Math.PI) *
                Math.pow(t, e + 0.5) *
                Math.exp(-t) *
                r;
            },
            Complex: function(t) {
              ...
              0 == h.im
                ? (h.re *= c)
                : 0 == h.re ? (h.im *= c) : ((h.re *= c), (h.im *= c));
              var m = Math.exp(-r.re);
              return (r.re = m * Math.cos(-r.im)), (r.im =
                m * Math.sin(-r.im)), f(f(h, r), n);
            },
            BigNumber: function(t) {
              if (t.isInteger())
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(e) {
          ...
          if (t % 2 == 0) {
            for (
              var r = t / 2 - 1, n = l(e, r + 1), a = e[r], o = 0;
              o < r;
              ++o
            )
              f(e[o], a) > 0 && (a = e[o]);
    ...
    function(e, t, r) {
      function n(e, t, r, n, s) {
        return (i.prototype.type =
          'Complex'), (i.prototype.isComplex = !0), (i.prototype.toJSON = function() {
            ...
            : 0 == n
                ...
                : r < 0
                    ? r == -1
                        ...
                        : i +
                            ' - ' +
                            (/[\d-.]/.test(s.charAt(0)) ? s.substring(1) : s) +
                            'i'
                    : 1 == r ? i + ' + i' : i + ' + ' + s + 'i');
          ...
          i.prototype.toString), (i.fromJSON = function(e) {
          return new i(e);
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, c) {
        function d(e, t) {
          ...
          if (e && e.isMatrix === !0)
            'DenseMatrix' === e.type
              ? ((this._data = u.clone(e._data)), (this._size = u.clone(
                  e._size
                )), (this._datatype = t || e._datatype))
              : ((this._data = e.toArray()), (this._size = e.size()), (this._datatype =
                  t || e._datatype));
          else if (e && f(e.data) && f(e.size))
            (this._data = e.data), (this._size = e.size), (this._datatype =
              t || e.datatype);
          else if (f(e))
            (this._data = b(e)), (this._size = s.size(this._data)), s.validate(
              this._data,
              this._size
            ), (this._datatype = t);
          else {
        ...
        function b(e) {
          for (var t = 0, r = e.length; t < r; t++) {
            ...
            f(n)
              ? (e[t] = b(n))
              : n && n.isMatrix === !0 && (e[t] = b(n.valueOf()));
          }
          return e;
        }
        var N = n(r(75));
        (d.prototype = new N()), (d.prototype.type =
          'DenseMatrix'), (d.prototype.isDenseMatrix = !0), (d.prototype.storage = function() {
          return 'dense';
        ...
        var E = function(e, t, r) {
          ...
          return (e._size = t.slice(0)), (e._data = s.resize(
            e._data,
            e._size,
            r
          )), e;
        ...
        return (d.prototype.reshape = function(e, t) {
          ...
          if (
            ((t = t.map(function(e) {
              if (
                (e && e.isBigNumber === !0 && (e = e.toNumber()), !l(e) ||
                  !p(e) ||
                  e < 1)
              )
            ...
            if (
              (n && n.isBigNumber === !0 && (n = n.toNumber()), !l(n) || !p(n))
            )
              throw new TypeError('The parameter k must be an integer number');
          } else n = 0;
          ...
          return m(e, this._size[0]), m(t, this._size[0]), d._swapRows(
            e,
            t,
            this._data
          ), this;
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        function a(e, t, r) {
          ...
          (this.start = null != e ? parseFloat(e) : 0), (this.end = null != t
            ? parseFloat(t)
            : 0), (this.step = null != r ? parseFloat(r) : 1);
        }
        return (a.prototype.type =
          'Range'), (a.prototype.isRange = !0), (a.parse = function(e) {
          ...
          return i.sign(r) == i.sign(a)
            ? (e = Math.ceil(a / r))
            : 0 == a && (e = 0), isNaN(e) && (e = 0), [e];
        }), (a.prototype.min = function() {
          var e = this.size()[0];
          return e > 0
            ? this.step > 0 ? this.start : this.start + (e - 1) * this.step
            : void 0;
        }), (a.prototype.max = function() {
          var e = this.size()[0];
          return e > 0
            ? this.step > 0 ? this.start + (e - 1) * this.step : this.start
            : void 0;
        }), (a.prototype.forEach = function(e) {
          var t = this.start, r = this.step, n = this.end, i = 0;
          if (r > 0) for (; t < n; ) e(t, [i], this), (t += r), i++;
          else if (r < 0) for (; t > n; ) e(t, [i], this), (t += r), i++;
        }), (a.prototype.map = function(e) {
          var t = [];
          ...
          return 1 != this.step && (t += ':' + i.format(this.step, e)), (t +=
            ':' + i.format(this.end, e));
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (i.prototype.type =
          'ResultSet'), (i.prototype.isResultSet = !0), (i.prototype.valueOf = function() {
          return this.entries;
        }), (i.prototype.toString = function() {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, s, u) {
        function c(e, t) {
          ...
          (this.value = void 0 != e
            ? this._normalize(e)
            : null), (this.fixPrefix = !1), (this.isUnitListSimplified = !0);
        }
        function f() {
          for (; ' ' == R || '\t' == R; )
            h();
        ...
        function g() {
          ...
          return (t = e.charCodeAt(0)), (t >= 65 && t <= 90) ||
            (t >= 97 && t <= 122)
            ? e || null
            : null;
        }
        ...
        function x(t) {
          if ('BigNumber' === t.number) {
            ...
            (G.rad.value = new e.BigNumber(1)), (G.deg.value = r.div(
              180
            )), (G.grad.value = r.div(200)), (G.cycle.value = r.times(
              2
            )), (G.arcsec.value = r.div(648e3)), (G.arcmin.value = r.div(
              10800
            ));
          } else
            (G.rad.value = 1), (G.deg.value = Math.PI / 180), (G.grad.value =
              Math.PI / 200), (G.cycle.value = 2 * Math.PI), (G.arcsec.value =
              Math.PI / 648e3), (G.arcmin.value = Math.PI / 10800);
        }
        function w(e) {
          for (var t = 0; t < e.length; t++) {
            var r = e.charAt(t),
        ...
        (c.parse = function(r, n) {
          ...
          for (var s = 1, u = !1, l = [], p = 1; ; ) {
            ...
            if (null == x)
              throw new SyntaxError(
                'Unexpected "' + m + '" in "' + P + '" at index ' + I.toString()
              );
            var w = y(x);
            ...
            for (f(); ')' === R; ) {
              if (0 === l.length)
                throw new SyntaxError(
                  'Unmatched ")" in "' + P + '" at index ' + I.toString()
                );
              (p /= l.pop()), h(), f();
            }
            if (
          ...
          var e = new c();
          (e.fixPrefix = this.fixPrefix), (e.isUnitListSimplified = this.isUnitListSimplified), (e.value = a(
            this.value
          )), (e.dimensions = this.dimensions.slice(0)), (e.units = []);
          for (var t = 0; t < this.units.length; t++) {
            e.units[t] = {};
            for (var r in this.units[t])
              this.units[t].hasOwnProperty(r) &&
                (e.units[t][r] = this.units[t][r]);
          }
          return e;
          ...
          if (this._isDerived()) {
            ...
            for (var s = 0; s < this.units.length; s++)
              (t = a(this.units[s].unit.value)), (i = a(
                this.units[s].prefix.value
              )), (n = a(this.units[s].power)), (o = E(o, A(E(t, i), n)));
            return o;
          }
          return (a = c._getNumberConverter(z(e))), (t = a(
            this.units[0].unit.value
          )), (r = a(this.units[0].unit.offset)), (i = a(
          ...
          if (this._isDerived()) {
            ...
            for (var u = 0; u < this.units.length; u++)
              (r = o(this.units[u].unit.value)), (a = o(
                this.units[u].prefix.value
              )), (i = o(this.units[u].power)), (s = M(s, A(E(r, a), i)));
            return s;
          }
          return (o = c._getNumberConverter(z(e))), (r = o(
            this.units[0].unit.value
          )), (a = o(this.units[0].prefix.value)), (n = o(
          ...
          for (var t = 0; t < j.length; t++)
            if (
              Math.abs((this.dimensions[t] || 0) - (e.dimensions[t] || 0)) >
              1e-12
            )
              return !1;
          return !0;
          ...
          for (var t = this.clone(), r = 0; r < j.length; r++)
            t.dimensions[r] =
              (this.dimensions[r] || 0) + (e.dimensions[r] || 0);
          ...
          return null != t.value
            ? (t.value = A(t.value, e))
            : (t.value = null), (t.isUnitListSimplified = !1), U(t);
        });
        var U = function(e) {
          return e.equalBase(F.NONE) && null !== e.value && !t.predictable
            ? e.value
            : e;
        };
        (c.prototype.abs = function() {
          ...
          if ('string' == typeof e) {
            ...
            return (t.value = a(
              r
            )), (t.fixPrefix = !0), (t.isUnitListSimplified = !0), t;
          }
          if (e && e.isUnit) {
            if (!this.equalBase(e)) throw new Error('Units do not match');
            if (null !== e.value)
              throw new Error('Cannot convert to a unit with a value');
            return (t = e.clone()), (t.value = a(
              r
            )), (t.fixPrefix = !0), (t.isUnitListSimplified = !0), t;
          }
          ...
          var t = this;
          return e && (t = this.to(e)), t._isDerived()
          ...
          c.prototype.toString), (c.prototype.simplifyUnitListLazy = function() {
          ...
          for (var e = this.clone(), t = [], r = 0; r < j.length; r++) {
            ...
            if (Math.abs(e.dimensions[r] || 0) > 1e-12) {
              if (!V.si.hasOwnProperty(n))
                throw new Error(
                  'Cannot express custom unit ' + n + ' in SI units'
                );
              t.push({
                unit: V.si[n].unit,
          ...
          for (
            ...
            this.units[i].power > 0
              ? (r++, (e +=
                  ...
                  this.units[i].unit.name), Math.abs(this.units[i].power - 1) >
                  1e-15 && (e += '^' + this.units[i].power))
              ...
              this.units[i].power < 0 &&
                (r > 0
                  ? ((t +=
                      ' ' +
                      this.units[i].prefix.name +
                      this.units[i].unit.name), Math.abs(
                      this.units[i].power + 1
                    ) > 1e-15 && (t += '^' + -this.units[i].power))
                  : ((t +=
                      ' ' +
                      this.units[i].prefix.name +
                      this.units[i].unit.name), (t +=
                      '^' + this.units[i].power)));
          (e = e.substr(1)), (t = t.substr(1)), r > 1 &&
            n > 0 &&
            (e = '(' + e + ')'), n > 1 && r > 0 && (t = '(' + t + ')');
          var a = e;
          ...
          for (var o in a)
            if (a.hasOwnProperty(o)) {
              ...
              if (s.scientific) {
                var u = Math.abs(
                  Math.log(e / Math.pow(s.value * t, n)) / Math.LN10 - 1.2
                );
        ...
        return (c.createUnit = function(e, t) {
          ...
          if (
            (('undefined' != typeof t && null !== t) || (t = {}), 'string' !=
              typeof e)
          )
            throw new TypeError(
          ...
          if (t && 'Unit' === t.type) a = t.clone();
            ...
            (n = t.definition), (i = t.prefixes), (s = t.offset), t.aliases &&
              (o = t.aliases.valueOf());
          }
          if (o)
          ...
          (o = o || []), (s = s || 0), (i = i && i.toUpperCase
            ? q[i.toUpperCase()] || q.NONE
            : q.NONE);
          var f = {};
          if (a) {
            f = {
            ...
            for (var u in F)
              if (F.hasOwnProperty(u)) {
                for (var p = !0, h = 0; h < j.length; h++)
                  if (
                    Math.abs(
                      (f.dimensions[h] || 0) - (F[u].dimensions[h] || 0)
                    ) > 1e-12
                  ) {
                    p = !1;
                    break;
    ...
    function(e, t, r) {
      ...
      t.mixin = function(e) {
        var t = new n();
        return (e.on = t.on.bind(t)), (e.off = t.off.bind(
          t
        )), (e.once = t.once.bind(t)), (e.emit = t.emit.bind(t)), e;
      };
    },
    function(e, t, r) {
      e.exports = r(143);
    ...
    function(e, t, r) {
      ...
      function n(e, t, o, u, c) {
        c.on('config', function(r, i) {
        ...
        }), i(c, 'true', !0), i(c, 'false', !1), i(c, 'null', null), i(
          c,
          'uninitialized',
          r(3).UNINITIALIZED
        ), 'BigNumber' === t.number
          ? (i(c, 'Infinity', new e.BigNumber(1 / 0)), i(
              c,
              'NaN',
              new e.BigNumber(NaN)
            ), a(c, 'pi', function() {
          ...
          : (i(c, 'Infinity', 1 / 0), i(c, 'NaN', NaN), i(c, 'pi', Math.PI), i(
              c,
              'tau',
              2 * Math.PI
            ), i(c, 'e', Math.E), i(c, 'phi', 1.618033988749895), i(
              c,
              'E',
              c.e
            ), i(c, 'LN2', Math.LN2), i(c, 'LN10', Math.LN10), i(
              c,
              'LOG2E',
              Math.LOG2E
            ), i(c, 'LOG10E', Math.LOG10E), i(c, 'PI', c.pi), i(
              c,
              'SQRT1_2',
              Math.SQRT1_2
            ), i(c, 'SQRT2', Math.SQRT2)), i(c, 'i', e.Complex.I), i(
          c,
          'version',
          r(511)
        );
    ...
    function(e, t, r) {
      ...
      t.create = function(e) {
        function t(e) {
          ...
          return a === -1
            ? ((i = e.math === !0
                ...
                : e.factory(c.type, f, t, c.typed)), r.push(e), u.push(i))
            : (i = u[a]), i;
        }
        ...
        return (c.import = t(o)), (c.config = t(
          s
        )), (c.expression.mathWithTransform.config = c.config), e &&
          c.config(e), c;
      };
    },
    function(e, t, r) {
      ...
      function n(e, t, r, n, u) {
        ...
        function f(e, t, r) {
          if ((r.wrap && 'function' == typeof t && (t = p(t)), d(u[e]) && d(t)))
            return (t = r.override ? n(e, t.signatures) : n(u[e], t)), (u[
              e
            ] = t), l(e, t), void u.emit('import', e, function() {
              return t;
            });
        ...
        function l(e, t) {
          t && 'function' == typeof t.transform
            ? ((u.expression.transform[e] = t.transform), g[e] ||
                (u.expression.mathWithTransform[e] = t.transform))
            : (delete u.expression.transform[e], g[e] ||
                (u.expression.mathWithTransform[e] = t));
        }
        function p(e) {
          var t = function() {
        ...
        function h(e, t) {
          if ('string' == typeof e.name) {
            ...
            e.lazy !== !1
              ? (i(c, a, l), s ||
                  g[a] ||
                  i(u.expression.mathWithTransform, a, l))
              : ((c[a] = l()), s ||
                  g[a] ||
                  (u.expression.mathWithTransform[a] = l())), u.emit(
              'import',
              a,
              l,
              e.path
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (s.prototype.type =
          'Help'), (s.prototype.isHelp = !0), (s.prototype.toString = function() {
          var e = this.doc || {}, t = '\n';
          if (
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        function i() {
          throw new Error(
            'UpdateNode is deprecated. Use AssignmentNode instead.'
          );
        }
        return i;
      }
          ...
          x = function(e) {
            ...
            for (t = 0; t < i; ++t)
              for (r = 0; r < t && r < a; ++r) {
                if (c(0, d(b[t][r], 1e5)))
                  throw new Error(
                    'math.qr(): unknown error - R is not lower triangular (element (' +
                      t +
                      ', ' +
                      r +
                      ')  = ' +
      ...
      function n(e, t, n, i) {
        function a(e) {
          if (('log' != e.name && 'nthRoot' != e.name) || 2 != e.args.length) {
            for (var t = 0; t < e.args.length; ++t)
              e.args[t] = new u(0);
            throw (e.compile().eval(), new Error(
          ...
          g = i('_derivative', {
            ...
            'FunctionNode, Object': function(e, r) {
              ...
              switch (e.name) {
                ...
                case 'nthRoot':
                  ...
                  return (n = new f('/', 'divide', [
                    new u('1', t.number),
                    e.args[1],
                  ])), (r[n] = r[e.args[1]]), g(new f('^', 'pow', [o, n]), r);
                case 'log10':
                  n = new u('10', t.number);
                case 'log':
                ...
                case 'asin':
                  (s = !0), (i = new c('sqrt', [
                    new f('-', 'subtract', [
                      new u('1', t.number),
                      new f('^', 'pow', [o.clone(), new u('2', t.number)]),
                    ]),
                  ]));
                  break;
                case 'acos':
                  (s = !0), (l = !0), (i = new c('sqrt', [
                    new f('-', 'subtract', [
                      new u('1', t.number),
                      new f('^', 'pow', [o.clone(), new u('2', t.number)]),
                    ]),
                ...
                default:
                  throw new Error(
                    'Function "' + e.name + '" not supported by derivative'
                  );
              }
              var h, m;
              s ? ((h = '/'), (m = 'divide')) : ((h = '*'), (m = 'multiply'));
              var d = g(o, r);
              return l && (d = new f('-', 'unaryMinus', [d])), new f(h, m, [
                d,
                i,
              ]);
            },
            'OperatorNode, Object': function(e, r) {
              ...
              switch (e.op) {
                case '+':
                case '-':
                  return 1 == e.args.length
                    ? new f(e.op, e.fn, [g(n, r)])
                    : new f(e.op, e.fn, [g(n, r), g(i, r)]);
                case '*':
                  ...
                  return new f('+', 'add', [
                    new f('*', 'multiply', [g(n, r), i.clone()]),
                    new f('*', 'multiply', [n.clone(), g(i, r)]),
                  ]);
                case '/':
                  return void 0 !== r[i]
                    ? new f('/', 'divide', [g(n, r), i])
                    : void 0 !== r[n]
                        ? new f('*', 'multiply', [
                            new f('-', 'unaryMinus', [n]),
                            new f('/', 'divide', [
                ...
                case '^':
                  ...
                  if (void 0 !== r[i]) {
                    ...
                    var s = new f('^', 'pow', [
                      n.clone(),
                      new f('-', 'subtract', [i, new u('1', t.number)]),
                    ]);
                    return new f('*', 'multiply', [
                      i.clone(),
                      new f('*', 'multiply', [g(n, r), s]),
                    ]);
                  }
                  return new f('*', 'multiply', [
                    new f('^', 'pow', [n.clone(), i.clone()]),
                    new f('+', 'add', [
                      new f('*', 'multiply', [
                        g(n, r),
                        new f('/', 'divide', [i.clone(), n.clone()]),
                      ]),
                      new f('*', 'multiply', [
                        g(i, r),
                        new c('log', [n.clone()]),
                ...
                default:
                  throw new Error(
                    'Operator "' + e.op + '" not supported by derivative'
                  );
              }
            },
          });
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, i, a) {
        ...
        function f(e) {
          var t, r = e.s * e.n;
          return (t = r < 0
            ? new x('-', 'unaryMinus', [new y(-r)])
            : new y(r)), 1 === e.d ? t : new x('/', 'divide', [t, new y(e.d)]);
        }
        function l(e, t, r) {
          return t.reduce(function(t, n) {
            if (t.isNode || n.isNode)
              t.isNode ? n.isNode || (n = w(n)) : (t = w(t));
            else {
              try {
                return s(e, [t, n]);
              } catch (e) {}
        ...
        var h = n(r(97)),
          ...
          w = i({
            ...
            BigNumber: function(e) {
              return e < 0
                ? c(new y(e.negated().toString(), 'number'))
                : new y(e.toString(), 'number');
            },
            Complex: function(e) {
          ...
          b = i({
            string: function(e) {
              return 'BigNumber' === t.number
                ? a.bignumber(e)
                : 'Fraction' === t.number ? a.fraction(e) : u(parseFloat(e));
            },
            Fraction: function(e) {
              return e;
            },
      ...
      r(2).digits;
      (t.math = !0), (t.name = 'simplifyConstant'), (t.path =
        'algebra.simplify'), (t.factory = n);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, n, a) {
      ...
      function n(e, t, n) {
        var i = n(r(69)),
          ...
          f = function(e, t) {
            ...
            for (
              var g,
                ...
                G = 7 * (s + 1),
                H = I,
                V = p(s, B, R, U, j, H, L, G, q, $, F, D),
                Z = h(s, B, R, D, F, $, c, q, j, H, L),
                W = 0;
              Z < s;
              ...
              for (x = 1; x <= Y + 1; x++) {
                for (
                  x > Y
                    ? ((b = y), (N = Q), (E = R[U + y] - Y))
                    : ((b = k[Q++]), (N = B[b]), (E = R[U + b])), (w = 1);
                  w <= E;
                  w++
                )
                  (g = k[N++]), (M = R[q + g]) <= 0 ||
                    ((J += M), (R[q + g] = -M), (k[ee++] = g), R[L + g] != -1 &&
                      (H[R[L + g]] = H[g]), H[g] != -1
                      ? (R[L + H[g]] = R[L + g])
                      : (R[j + R[D + g]] = R[L + g]));
                b != y && ((B[b] = i(y)), (R[$ + b] = 0));
              ...
              for (
                0 !== Y && (P = ee), (R[D + y] = J), (B[y] = K), (R[U + y] =
                  ee - K), (R[F + y] = -2), (V = m(V, u, R, $, s)), (A = K);
                A < ee;
                A++
              )
                if (((g = k[A]), !((O = R[F + g]) <= 0))) {
              ...
              for (A = K; A < ee; A++) {
                ...
                0 === z
                  ? ((B[g] = i(y)), (M = -R[
                      q + g
                    ]), (J -= M), (X += M), (Z += M), (R[q + g] = 0), (R[
                      F + g
                    ] = -1))
                  : ((R[D + g] = Math.min(R[D + g], z)), (k[S] = k[ne]), (k[
                      ne
                    ] =
                      k[T]), (k[T] = y), (R[U + g] = S - T + 1), (C =
                      (C < 0 ? -C : C) % s), (R[L + g] = R[G + C]), (R[
                      G + C
                    ] = g), (H[g] = C));
              }
              for (
                (R[D + y] = J), (u = Math.max(u, J)), (V = m(
                  V + u,
                  u,
                  R,
                  $,
                ...
                if (((g = k[A]), !(R[q + g] >= 0)))
                  for (
                    (C = H[g]), (g = R[G + C]), (R[G + C] = -1);
                    g != -1 && R[L + g] != -1;
                    (g = R[L + g]), V++
                  ) {
                    for (
                      (E = R[U + g]), (O = R[F + g]), (Q = B[g] + 1);
                      Q <= B[g] + E - 1;
                      Q++
                    )
                      R[$ + k[Q]] = V;
                    ...
                    for (v = R[L + g]; v != -1; ) {
                      ...
                      for (Q = B[v] + 1; se && Q <= B[v] + E - 1; Q++)
                        R[$ + k[Q]] != V && (se = 0);
                      se
                        ? ((B[v] = i(g)), (R[q + g] += R[q + v]), (R[
                            q + v
                          ] = 0), (R[F + v] = -1), (v = R[L + v]), (R[
                            L + oe
                          ] = v))
              ...
              for ((Q = K), (A = K); A < ee; A++)
                (g = k[A]), (M = -R[q + g]) <= 0 ||
                  ((R[q + g] = M), (z = R[D + g] + J - M), (z = Math.min(
                    z,
                    s - Z - M
                  )), R[j + z] != -1 && (H[R[j + z]] = g), (R[L + g] =
                    R[j + z]), (H[g] = -1), (R[j + z] = g), (W = Math.min(
                    W,
                    z
                  )), (R[D + g] = z), (k[Q++] = g));
              (R[q + y] = X), 0 === (R[U + y] = Q - K) &&
          ...
          p = function(e, t, r, n, i, a, o, s, u, c, f, l) {
            ...
            r[n + e] = 0;
            for (var h = 0; h <= e; h++)
              (r[i + h] = -1), (a[h] = -1), (r[o + h] = -1), (r[
                s + h
              ] = -1), (r[u + h] = 1), (r[c + h] = 1), (r[f + h] = 0), (r[
                l + h
              ] =
                r[n + h]);
            var d = m(0, 0, r, c, e);
    ...
    function(e, t, r) {
      ...
      function n() {
        var e = function(e, t, r) {
          ...
          return (a[s] = u), i.splice(u, i.length - u), n &&
            n.splice(u, n.length - u), u;
        };
        return e;
      }
        ...
        var i = n(r(26)),
          ...
          l = function(e, t, r) {
            ...
            for (var _ = 0; _ < p; _++) {
              ...
              var P = O[z];
              for (
                (N[m] = _), (b[m++] = P), (A[z] = _), (y[h] = z), (v[
                  h++
                ] = 1), (g = C);
                g < p;
                g++
              )
                (d = T[g]), A[d] < 0 && ((y[h] = d), (v[h++] = a(O[d], P))), (O[
                  d
                ] = 0);
            }
            for ((x[p] = h), (E[p] = m), (g = 0); g < h; g++)
              y[g] = A[y[g]];
            return v.splice(h, v.length - h), y.splice(
              h,
              y.length - h
            ), b.splice(m, b.length - m), N.splice(m, N.length - m), {
              L: w,
              U: M,
              pinv: A,
            };
        ...
        var t = e.SparseMatrix,
          r = function(e, r, n, i) {
            for (
              ...
              m[g] = d;
              for (
                var v = n ? n[g] : g, y = s[v], x = s[v + 1], w = y;
                w < x;
                w++
              ) {
                var b = r ? r[o[w]] : o[w];
      ...
      function n(e, t, n) {
        var i = n(r(354)),
          ...
          f = function(e, t) {
            ...
            for (s = a - 1; s >= 0; s--)
              (h[s] = -1), (u = m[s]), u != -1 &&
                (0 === d[x + u]++ && (d[y + u] = s), (d[g + s] = d[v + u]), (d[
                  v + u
                ] = s));
            for ((t.lnz = 0), (t.m2 = a), (u = 0); u < o; u++)
              if (
                ((s = d[v + u]), t.lnz++, s < 0 && (s = t.m2++), (h[
                  s
                ] = u), !(--x[u] <= 0))
              ) {
                t.lnz += d[x + u];
                var w = p[u];
                w != -1 &&
                  (0 === d[x + w] && (d[y + w] = d[y + u]), (d[g + d[y + u]] =
                    d[v + w]), (d[v + w] = d[g + s]), (d[x + w] += d[x + u]));
              }
            for (s = 0; s < a; s++)
              h[s] < 0 && (h[s] = u++);
            return !0;
      ...
      function n(e, t, n, o) {
        function s(r, n) {
          ...
          if (n) {
            var u = [
              s,
              new e.Complex(a(o), 0).mul(
                new e.Complex(0, i + 2 * Math.PI / 3).exp()
              ),
              new e.Complex(a(o), 0).mul(
                new e.Complex(0, i - 2 * Math.PI / 3).exp()
              ),
        ...
        function u(t) {
          ...
          n && (t.value = c(t.value));
          var i;
          i = t.value && t.value.isBigNumber
            ? new e.BigNumber(1).div(3)
            : t.value && t.value.isFraction ? new e.Fraction(1, 3) : 1 / 3;
          var r = t.pow(i);
      ...
      var i = r(1),
        a =
          ...
          function(e) {
            if (0 === e) return e;
            var t, r = e < 0;
            return r && (e = -e), isFinite(e)
              ? ((t = Math.exp(Math.log(e) / 3)), (t =
                  (e / (t * t) + 2 * t) / 3))
              : (t = e), r ? -t : t;
          };
      ...
      function n(e, t, r, n) {
        var o = n('log10', {
          number: function(r) {
            return r >= 0 || t.predictable
              ? a(r)
              : new e.Complex(r, 0).log().div(Math.LN10);
          },
          Complex: function(t) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(t, r) {
          ...
          return (u = t.isNeg() ? u.neg() : u), new e.BigNumber(
            (s ? o.div(u) : u).toPrecision(n)
          );
        }
        var u = n(r(0)),
          c = n(r(29)),
      ...
      function a(e, t) {
        ...
        for (
          var r = e.arg(), n = e.abs(), i = [], a = Math.pow(n, 1 / t), o = 0;
          o < t;
          o++
        )
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e, r) {
          ...
          for (; r; )
            (a = Math.floor(e / r)), (o = e - a * r), (n = s), (s =
              c - a * s), (c = n), (n = f), (f =
              l - a * f), (l = n), (e = r), (r = o);
          var p;
          return (p = e < 0 ? [-e, -c, -l] : [e, e ? c : 0, l]), 'Array' ===
            t.matrix
            ? p
            : u(p);
        }
        function s(r, n) {
          ...
          for (; !n.isZero(); )
            (a = r.div(n).floor()), (o = r.mod(n)), (i = f), (f = l.minus(
              a.times(f)
            )), (l = i), (i = p), (p = h.minus(
              a.times(p)
            )), (h = i), (r = n), (n = o);
          ...
          return (m = r.lt(s)
            ? [r.neg(), l.neg(), h.neg()]
            : [r, r.isZero() ? 0 : l, h]), 'Array' === t.matrix ? m : u(m);
        }
        var u = n(r(0)),
    ...
    function(e, t, r) {
        ...
        var m = (n(r(0)), s('distance', {
          ...
          'Object, Object, Object': function(e, t, r) {
            if (
              ...
              if (!i(e))
                throw new TypeError(
                  'Values of pointX and pointY should be numbers'
                );
              if (!i(t))
                throw new TypeError(
                  'Values of lineOnePtX and lineOnePtY should be numbers'
                );
              if (!i(r))
                throw new TypeError(
                  'Values of lineTwoPtX and lineTwoPtY should be numbers'
                );
              if (
                ...
                var n =
                  (r.lineTwoPtY - r.lineTwoPtX) / (t.lineOnePtY - t.lineOnePtX),
                  a = n * n * t.lineOnePtX,
                  o = -1 * (n * t.lineOnePtX),
                  s = e.pointX;
          ...
          'Array, Array': function(e, t) {
            ...
            if (3 == e.length && 6 == t.length) {
              ...
              if (!o(t))
                throw new TypeError(
                  'Array with 6 numbers expected for second argument'
                );
          ...
          'Object, Object': function(e, t) {
            ...
            if (3 == Object.keys(e).length && 6 == Object.keys(t).length) {
              if (!a(e))
                throw new TypeError(
                  'Values of pointX, pointY and pointZ should be numbers'
                );
              if (!o(t))
                throw new TypeError(
                  'Values of x0, y0, z0, a, b and c should be numbers'
                );
              if (
                e.hasOwnProperty('pointX') &&
                e.hasOwnProperty('pointY') &&
            ...
            if (2 == Object.keys(e).length && 2 == Object.keys(t).length) {
              if (!i(e))
                throw new TypeError(
                  'Values of pointOneX and pointOneY should be numbers'
                );
              if (!i(t))
                throw new TypeError(
                  'Values of pointTwoX and pointTwoY should be numbers'
                );
              if (
      ...
      function i(e) {
        return e.constructor !== Array && (e = s(e)), 'number' == typeof e[0] &&
          'number' == typeof e[1];
      }
      function a(e) {
        return e.constructor !== Array && (e = s(e)), 'number' == typeof e[0] &&
      ...
      function f(e, t, r, n, i, a, o, s, u) {
        ...
        var f = Math.pow(o * o + s * s + u * u, 0.5), l = c / f;
        return l;
      }
      function l(e, t, r, n) {
        var i = n - t, a = r - e, o = i * i + a * a, s = Math.pow(o, 0.5);
        return s;
      }
        ...
        for (var t = [], r = 0; r < e.length - 1; r++)
          for (var n = r + 1; n < e.length; n++)
            2 == e[0].length
              ...
              : 3 == e[0].length &&
                  t.push(
                    p(e[r][0], e[r][1], e[r][2], e[n][0], e[n][1], e[n][2])
                  );
        return t;
      }
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e, t) {
          if (
            (1 === i(e).length && (e = [e]), 1 === i(t).length && (t = [t]), i(
              e
            ).length > 2 || i(t).length > 2)
          )
            throw new RangeError(
      ...
      function n(e, t, n, f) {
        ...
        var p = n(r(0)),
          h = function(e, r, n) {
            ...
            if (
              (r && r.isMatrix === !0 && (r = r.valueOf()), r.length &&
                r[0] &&
                r[0].isBigNumber === !0 &&
                (r = r.map(function(e) {
      ...
      function n(e, t, n, a) {
        function o(e) {
          if (((e = i(e.valueOf())), 0 === e.length))
            throw new Error(
              'Cannot calculate median absolute deviation of an empty array'
            );
          var t = c(e);
          return c(
            u(e, function(e) {
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        function a(e) {
          ...
          var r = {}, n = [], a = 0;
          for (var o in e)
            e[o] in r || (r[e[o]] = 0), r[e[o]]++, r[e[o]] == a
              ? n.push(e[o])
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n('acos', {
          number: function(r) {
            return (r >= -1 && r <= 1) || t.predictable
              ? Math.acos(r)
              : new e.Complex(r, 0).acos();
          },
          Complex: function(e) {
            return e.acos();
          },
    ...
    function(e, t, r) {
      ...
      function i(e) {
        return 0 == e
          ...
          : Math.abs(2 / (Math.exp(e) - Math.exp(-e))) * o(e);
      }
    ...
    function(e, t, r) {
      function n(e, t, r, n, a) {
        ...
        return (o.prototype.type =
          'BigNumber'), (o.prototype.isBigNumber = !0), (o.prototype.toJSON = function() {
    ...
    function(e, t, r) {
      ...
      function n(e, t, r, n, o) {
        ...
        return (s.prototype.type =
          'Chain'), (s.prototype.isChain = !0), (s.prototype.done = function() {
          return this.value;
      ...
      (t.name = 'Chain'), (t.path =
        'type'), (t.factory = n), (t.math = !0), (t.lazy = !1);
    },
    function(e, t, r) {
      'use strict';
      function n(e, t, r, n) {
    ...
    function(e, t, r) {
      ...
      var i = r(514);
      (i.prototype.type =
        'Fraction'), (i.prototype.isFraction = !0), (i.prototype.toJSON = function() {
    ...
    function(e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        (a.prototype.type =
          'FibonacciHeap'), (a.prototype.isFibonacciHeap = !0), (a.prototype.insert = function(
          e,
          t
        ) {
          ...
          if (this._minimum) {
            var n = this._minimum;
            (r.left = n), (r.right =
              n.right), (n.right = r), (r.right.left = r), o(e, n.key) &&
              (this._minimum = r);
          ...
          for (var t = this._minimum, r = e.degree, n = e.child; r > 0; ) {
            var i = n.right;
            (n.left.right = n.right), (n.right.left =
              n.left), (n.left = t), (n.right =
              t.right), (t.right = n), (n.right.left = n), (n.parent = null), (n = i), r--;
          }
          return (e.left.right = e.right), (e.right.left = e.left), e == e.right
            ? (t = null)
            : ((t = e.right), (t = h(t, this._size))), this
            ._size--, (this._minimum = t), e;
        ...
        var c = function(e, t, r) {
          t.key = r;
          var n = t.parent;
          return n && o(t.key, n.key) && (f(e, t, n), l(e, n)), o(
            t.key,
            e.key
          ) && (e = t), e;
        },
          f = function(e, t, r) {
            (t.left.right = t.right), (t.right.left =
              t.left), r.degree--, r.child == t && (r.child = t.right), 0 ===
              r.degree && (r.child = null), (t.left = e), (t.right =
              e.right), (e.right = t), (t.right.left = t), (t.parent = null), (t.mark = !1);
          },
          l = function(e, t) {
            var r = t.parent;
          ...
          p = function(e, t) {
            (e.left.right = e.right), (e.right.left =
              e.left), (e.parent = t), t.child
              ? ((e.left = t.child), (e.right =
                  t.child.right), (t.child.right = e), (e.right.left = e))
              : ((t.child = e), (e.right = e), (e.left = e)), t.degree++, (e.mark = !1);
          },
          h = function(e, t) {
            ...
            for (var m = 0; m < r; m++)
              (c = n[m]), c &&
                (e
                  ? ((c.left.right = c.right), (c.right.left =
                      c.left), (c.left = e), (c.right =
                      e.right), (e.right = c), (c.right.left = c), o(
                      c.key,
                      e.key
                    ) && (e = c))
                  : (e = c));
      ...
      function n(e, t, n) {
        function a(e, t) {
          ...
          if ((e && e.isMatrix === !0) || s(e)) {
            var r = new c(e, t);
            (this._data = r._data), (this._size = r._size), (this._datatype =
              r._datatype), (this._min = null), (this._max = null);
          } else if (e && s(e.data) && s(e.size))
            (this._data = e.data), (this._size = e.size), (this._datatype =
              e.datatype), (this._min = 'undefined' != typeof e.min
              ? e.min
              : null), (this._max = 'undefined' != typeof e.max ? e.max : null);
          else {
            if (e)
              throw new TypeError(
                'Unsupported type of data (' + i.types.type(e) + ')'
            ...
            (this._data = []), (this._size = [
              0,
            ]), (this._datatype = t), (this._min = null), (this._max = null);
          }
        }
        var c = n(r(133)), f = n(r(40));
        return (a.prototype = new c()), (a.prototype.type =
          'ImmutableDenseMatrix'), (a.prototype.isImmutableDenseMatrix = !0), (a.prototype.subset = function(
          e
        ) {
          switch (arguments.length) {
            case 1:
              ...
              return t.isMatrix
                ? new a({ data: t._data, size: t._size, datatype: t._datatype })
                : t;
            case 2:
            case 3:
              throw new Error(
    ...
    function(e, t, r) {
      ...
      function n(e) {
        ...
        return (t.prototype.type =
          'Index'), (t.prototype.isIndex = !0), (t.prototype.clone = function() {
          var e = new t();
          return (e._dimensions = i(
            this._dimensions
          )), (e._isScalar = this._isScalar), e;
        }), (t.create = function(e) {
          var r = new t();
          ...
          t.prototype.toArray), (t.prototype.toString = function() {
          for (var e = [], t = 0, r = this._dimensions.length; t < r; t++) {
            var n = this._dimensions[t];
            'string' == typeof n
    ...
    function(e, t, r) {
      ...
      function n(e, t, n) {
        ...
        return (i.prototype.type =
          'Spa'), (i.prototype.isSpa = !0), (i.prototype.set = function(e, t) {
          ...
          for (s && a.push(s); s && s.key <= t; )
            s.key >= e &&
              (o(s.value, 0) ||
                r(s.key, s.value, this)), (s = n.extractMinimum()), s &&
              a.push(s);
          ...
          if (!r && n)
            (r = this._heap.insert(e, n.value)), this._heap.remove(
              n
            ), (this._values[e] = r), (this._values[t] = void 0);
          else if (r && !n)
            (n = this._heap.insert(t, r.value)), this._heap.remove(
              r
            ), (this._values[t] = n), (this._values[e] = void 0);
          else if (r && n) {
            var i = r.value;
      ...
      function n(e, t, n, d) {
        function g(e, t) {
          ...
          if (e && e.isMatrix === !0) x(this, e, t);
            ...
            (this._values = e.values), (this._index = e.index), (this._ptr =
              e.ptr), (this._size = e.size), (this._datatype = t || e.datatype);
            ...
            (this._values = []), (this._index = []), (this._ptr = [
              0,
            ]), (this._size = [0, 0]), (this._datatype = t);
          }
        }
        var v = n(r(75)),
          y = n(r(10)),
          x = function(e, t, r) {
            'SparseMatrix' === t.type
              ? ((e._values = t._values
                  ? s.clone(t._values)
                  : void 0), (e._index = s.clone(t._index)), (e._ptr = s.clone(
                  t._ptr
                )), (e._size = s.clone(t._size)), (e._datatype =
                  r || t._datatype))
              : w(e, t.valueOf(), r || t._datatype);
          },
          w = function(e, t, r) {
            ...
            if (
              (h(r) &&
                ((a = d.find(y, [r, r]) || y), (o = d.convert(0, r))), n > 0)
            ) {
              var s = 0;
              do {
                ...
                for (var u = 0; u < n; u++) {
                  ...
                  if (f(c)) {
                    ...
                    0 === s && i < 1 && (i = 1), a(c, o) ||
                      (e._values.push(c), e._index.push(u));
                }
                s++;
              } while (s < i);
            }
        ...
        (g.prototype = new v()), (g.prototype.type =
          'SparseMatrix'), (g.prototype.isSparseMatrix = !0), (g.prototype.storage = function() {
          return 'sparse';
        ...
        var b = function(e, t) {
          ...
          for ((i = 0), (o = e._size.length); i < o; i++)
          ...
          N = function(e, t, r, n) {
            ...
            if (
              ...
              for (
                var p = t.min()[0], h = t.min()[1], m = i[0], d = i[1], g = 0;
                g < m;
                g++
              )
                for (var v = 0; v < d; v++) {
        ...
        (g.prototype.get = function(e) {
          ...
          h(this._datatype) &&
            ((u =
              d.find(y, [this._datatype, this._datatype]) || y), (c = d.convert(
              0,
              this._datatype
            ))), (n > o - 1 || i > s - 1) &&
            (O(this, Math.max(n + 1, o), Math.max(i + 1, s), r), (o = this
              ._size[0]), (s = this._size[1])), m(n, o), m(i, s);
          var l = E(n, this._ptr[i], this._ptr[i + 1], this._index);
          return l < this._ptr[i + 1] && this._index[l] === n
            ? u(t, c)
                ? M(l, i, this._values, this._index, this._ptr)
                : (this._values[l] = t)
            : A(l, n, i, t, this._values, this._index, this._ptr), this;
        });
        ...
        var O = function(e, t, r, n) {
          var i = n || 0, a = y, o = 0;
          h(e._datatype) &&
            ((a = d.find(y, [e._datatype, e._datatype]) || y), (o = d.convert(
              0,
              e._datatype
          ...
          if (r > p) {
            ...
            r < p &&
              (e._ptr.splice(r + 1, p - r), e._values.splice(
                e._ptr[r],
                e._values.length
          ...
          if (((p = r), t > l)) {
            if (f) {
              ...
              for (u = 0; u < p; u++) {
                ...
                var g = 0;
                for (s = l; s < t; s++, g++)
                  e._values.splice(c + g, 0, i), e._index.splice(
                    c + g,
                    0,
                    s
                  ), m++;
            ...
            for (u = 0; u < p; u++) {
              ...
              for (c = x; c < w; c++)
                (s = e._index[c]), s > t - 1 &&
                  (e._values.splice(c, 1), e._index.splice(c, 1), v++);
            }
        ...
        (g.prototype.reshape = function(e, t) {
          ...
          for (var n = [], i = 0; i < r._ptr.length; i++)
            for (var a = 0; a < r._ptr[i + 1] - r._ptr[i]; a++)
              n.push(i);
          for (
            var o = r._values.slice(), s = r._index.slice(), i = 0;
            i < r._index.length;
            i++
          ) {
          ...
          (r._values.length = 0), (r._index.length = 0), (r._ptr.length =
            e[1] + 1), (r._size = e.slice());
        ...
        var T = function(e, t, r, n, i, a, o) {
          var s = [], u = [], c = [], f = y, l = 0;
          h(e._datatype) &&
            ((f = d.find(y, [e._datatype, e._datatype]) || y), (l = d.convert(
              0,
              e._datatype
            )));
          for (
            ...
            c.push(s.length);
            for (
              var v = e._ptr[m], x = e._ptr[m + 1], w = t, b = v;
              b < x;
              b++
            ) {
              var N = e._index[b];
        ...
        return (g.prototype.format = function(e) {
          ...
          for (var c = t; c < i && o.length < a; c++)
            for (
              var f = this._ptr[c], h = this._ptr[c + 1], m = f;
              m < h;
              m++
            ) {
              var d = this._index[m];
          ...
          if (2 !== this._size.length)
            throw new Error('Only two dimensional matrix is supported');
          return m(e, this._size[0]), m(t, this._size[0]), g._swapRows(
            e,
            t,
            this._size[1],
            this._values,
          ...
          for (var o = 0; o < r; o++) {
            ...
            if (c < u && f < u && i[c] === e && i[f] === t) {
              ...
              var p = n ? n[c] : void 0;
              i.splice(f, 0, t), n && n.splice(f, 0, p), i.splice(
                f <= c ? c + 1 : c,
                1
              ), n && n.splice(f <= c ? c + 1 : c, 1);
            } else if (f < u && i[f] === t && (c >= u || i[c] !== e)) {
              var h = n ? n[f] : void 0;
              i.splice(c, 0, e), n && n.splice(c, 0, h), i.splice(
                c <= f ? f + 1 : f,
                1
        ...
        return e.eq(a)
          ...
          : t.eq(a)
              ...
              : e.isFinite() && t.isFinite()
                  ...
                  : e.isFinite() || t.isFinite()
                      ? new r(
                          e.isNegative() == t.isNegative() ? 1 / 0 : -(1 / 0)
                        )
                      : a;
      };
    },
    function(e, t) {
      (t.format = function(e, r) {
        ...
        var n = 'auto', i = void 0;
        switch ((void 0 !== r &&
          (r.notation && (n = r.notation), 'number' == typeof r
            ? (i = r)
            : r.precision && (i = r.precision)), n)) {
          case 'fixed':
            return t.toFixed(e, i);
          ...
          case 'auto':
            ...
            r &&
              r.exponential &&
              (void 0 !== r.exponential.lower &&
                (a = r.exponential.lower), void 0 !== r.exponential.upper &&
    ...
    function(e, t, r) {
      ...
      e.exports = function(e, t, r, n, i, a, o, s, u, c, f) {
        ...
        if (n)
          for ((p = v[t]), (h = v[t + 1]), (l = p); l < h; l++)
            (m = g[l]), r[m] !== a
              ? ((r[m] = a), y.push(m), c
                  ? ((n[m] = u ? s(d[l], f) : s(f, d[l])), (i[m] = a))
                  : (n[m] = d[l]))
              : ((n[m] = u ? s(d[l], n[m]) : s(n[m], d[l])), (i[m] = a));
        else
          for ((p = v[t]), (h = v[t + 1]), (l = p); l < h; l++)
      ...
      !(function(r) {
        ...
        function o(e, t) {
          return this instanceof o
            ? (c(e, t), (this.re = s.re), void (this.im = s.im))
            : new o(e, t);
        }
        var s = { re: 0, im: 0 };
        (Math.cosh =
              ...
              switch (typeof e) {
                case 'object':
                  'im' in e && 're' in e
                    ? ((s.re = e.re), (s.im = e.im))
                    : 'abs' in e && 'arg' in e
                        ? ((s.re = e.abs * Math.cos(e.arg)), (s.im =
                            e.abs * Math.sin(e.arg)))
                        : 'r' in e && 'phi' in e
                            ? ((s.re = e.r * Math.cos(e.phi)), (s.im =
                                e.r * Math.sin(e.phi)))
                            : u();
                  break;
                case 'string':
        ...
        (o.prototype = {
          ...
          mul: function(e, t) {
            return c(e, t), 0 === s.im && 0 === this.im
              ? new o(this.re * s.re, 0)
              : new o(
          ...
          pow: function(e, t) {
            if ((c(e, t), (e = this.re), (t = this.im), 0 === e && 0 === t))
              return new o(0, 0);
            ...
            return (e = Math.exp(s.re * n - s.im * r)), (t =
              s.im * n + s.re * r), new o(e * Math.cos(t), e * Math.sin(t));
          },
          sqrt: function() {
            ...
            return r >= 0 && 0 === n
              ...
              : ((e = r >= 0
                  ? 0.5 * Math.sqrt(2 * (i + r))
                  : Math.abs(n) / Math.sqrt(2 * (i - r))), (t = r <= 0
                  ? 0.5 * Math.sqrt(2 * (i - r))
                  : Math.abs(n) / Math.sqrt(2 * (i + r))), new o(
                  e,
                  n >= 0 ? t : -t
                ));
          },
          ...
          abs: function() {
            ...
            return e < 3e3 && t < 3e3
              ? Math.sqrt(e * e + t * t)
              : (e < t
                  ? ((e = t), (t = this.re / this.im))
                  : (t = this.im / this.re), e * Math.sqrt(1 + t * t));
          },
          arg: function() {
          ...
          sin: function() {
            var e = this.re, t = this.im;
            return new o(
              Math.sin(e) * Math.cosh(t),
              Math.cos(e) * Math.sinh(t)
            );
          },
          cos: function() {
            var e = this.re, t = this.im;
            return new o(
              Math.cos(e) * Math.cosh(t),
              -Math.sin(e) * Math.sinh(t)
            );
          },
          tan: function() {
            var e = 2 * this.re,
          ...
          sec: function() {
            ...
            return new o(
              Math.cos(e) * Math.cosh(t) / r,
              Math.sin(e) * Math.sinh(t) / r
            );
          },
          csc: function() {
            var e = this.re,
              ...
              r = 0.5 * Math.cosh(2 * t) - 0.5 * Math.cos(2 * e);
            return new o(
              Math.sin(e) * Math.cosh(t) / r,
              -Math.cos(e) * Math.sinh(t) / r
            );
          },
          asin: function() {
            var e = this.re,
          ...
          atan: function() {
            ...
            return new o(-0.5 * n.im, 0.5 * n.re);
          },
          acot: function() {
            var e = this.re, t = this.im;
            ...
            return 0 !== r
              ? new o(e / r, -t / r).atan()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).atan();
          },
          asec: function() {
            var e = this.re, t = this.im;
            ...
            return 0 !== r
              ? new o(e / r, -t / r).acos()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).acos();
          },
          acsc: function() {
            var e = this.re, t = this.im;
            ...
            return 0 !== r
              ? new o(e / r, -t / r).asin()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).asin();
          },
          sinh: function() {
            var e = this.re, t = this.im;
            return new o(
              Math.sinh(e) * Math.cos(t),
              Math.cosh(e) * Math.sin(t)
            );
          },
          cosh: function() {
            var e = this.re, t = this.im;
            return new o(
              Math.cosh(e) * Math.cos(t),
              Math.sinh(e) * Math.sin(t)
            );
          },
          tanh: function() {
            var e = 2 * this.re,
          ...
          asinh: function() {
            ...
            var t = this.asin();
            return (this.re = -this.im), (this.im = e), (e =
              t.re), (t.re = -t.im), (t.im = e), t;
          },
          acosh: function() {
            var e, t = this.acos();
            return t.im <= 0
              ? ((e = t.re), (t.re = -t.im), (t.im = e))
              : ((e = t.im), (t.im = -t.re), (t.re = e)), t;
          },
          atanh: function() {
            var e = this.re,
              t = this.im,
              ...
              s = n * n + t * t,
              u = 0 !== s
                ? new o((i * n - t * t) / s, (t * n + i * t) / s)
                : new o(e !== -1 ? e / 0 : 0, 0 !== t ? t / 0 : 0),
              c = u.re;
            return (u.re = a(u.re, u.im) / 2), (u.im =
              Math.atan2(u.im, c) / 2), r && (u.im = -u.im), u;
          },
          acoth: function() {
            var e = this.re, t = this.im;
            ...
            return 0 !== r
              ? new o(e / r, -t / r).atanh()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).atanh();
          },
          acsch: function() {
            var e = this.re, t = this.im;
            if (0 === t)
            ...
            return 0 !== r
              ? new o(e / r, -t / r).asinh()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).asinh();
          },
          asech: function() {
            var e = this.re, t = this.im;
            ...
            return 0 !== r
              ? new o(e / r, -t / r).acosh()
              : new o(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).acosh();
          },
          inverse: function() {
          ...
          ceil: function(e) {
            return (e = Math.pow(10, e || 0)), new o(
          ...
          equals: function(e, t) {
            return c(e, t), Math.abs(s.re - this.re) <= o.EPSILON &&
              Math.abs(s.im - this.im) <= o.EPSILON;
          },
          clone: function() {
            return new o(this.re, this.im);
          },
        ...
        }), (o.ZERO = new o(0, 0)), (o.ONE = new o(1, 0)), (o.I = new o(
          0,
          1
        )), (o.PI = new o(Math.PI, 0)), (o.E = new o(
          Math.E,
          0
        )), (o.EPSILON = 1e-16), (n = []), (i = function() {
          return o;
      ...
      !(function(i) {
          ...
          return --t < 0
            ...
            ? t < 3
                ? (0 == t
                    ...
                    0 == s))
                : (o =
                    (((r < 4 && s + 1 == a) || (r > 3 && s + 1 == a / 2)) &&
                      ((e[i + 1] / a / 100) | 0) == _e(10, t - 2) - 1) ||
            ...
            : t < 4
                ? (0 == t
                    ...
                    : 1 == t
                        ? (s = (s / 100) | 0)
                        : 2 == t && (s = (s / 10) | 0), (o =
                    ((n || r < 4) && 9999 == s) || (!n && r > 3 && 4999 == s)))
                : (o =
                    (((n || r < 4) && s + 1 == a) ||
                      (!n && r > 3 && s + 1 == a / 2)) &&
                    ((e[i + 1] / a / 1e3) | 0) == _e(10, t - 3) - 1), o;
        }
        function u(e, t, r) {
          for (var n, i, a = [0], o = 0, s = e.length; o < s; ) {
            for (i = a.length; i--; )
              a[i] *= t;
            for (
              (a[0] += ye.indexOf(e.charAt(o++))), (n = 0);
              n < a.length;
              n++
            )
              a[n] > r - 1 &&
                (void 0 === a[n + 1] && (a[n + 1] = 0), (a[n + 1] +=
                  (a[n] / r) | 0), (a[n] %= r));
          }
          return a.reverse();
        }
        function c(e, t) {
          ...
          i < 32
            ...
            : ((r = 16), (n =
                '2.3283064365386962890625e-10')), (e.precision += r), (t = O(
            e,
            1,
            t.times(n),
            new e(1)
        ...
        function f(e, t, r, n) {
          ...
          e: if (null != t) {
            ...
            if (
              ...
              return (l.length = 0), c
                ? ((t -= e.e + 1), (l[0] = _e(10, (Pe - t % Pe) % Pe)), (e.e =
                    -t || 0))
                : (l[0] = e.e = 0), e;
            if (
              (0 == a
                ? ((l.length = p), (s = 1), p--)
                : ((l.length = p + 1), (s = _e(10, Pe - a)), (l[p] = o > 0
                    ? ((f / _e(10, i - o) % _e(10, o)) | 0) * s
                    : 0)), c)
            )
              for (;;) {
                if (0 == p) {
        ...
        function l(e, t, r) {
          ...
          return t
            ? (r && (n = r - s) > 0
                ? (o = o.charAt(0) + '.' + o.slice(1) + g(n))
                : s > 1 && (o = o.charAt(0) + '.' + o.slice(1)), (o =
                o + (e.e < 0 ? 'e' : 'e+') + e.e))
            : i < 0
                ? ((o = '0.' + g(-i - 1) + o), r &&
                    (n = r - s) > 0 &&
        ...
        function v(e, t, r, n) {
          ...
          for (Ne = !1; ; ) {
            if (
              (r % 2 && ((a = a.times(t)), S(a.d, o) && (i = !0)), (r = Te(
                r / 2
              )), 0 === r)
            ) {
        ...
        function w(e, t) {
          ...
          for (
            null == t ? ((Ne = !1), (l = v)) : (l = t), (c = new d(0.03125));
            e.e > -2;
          ...
          for (
            (n =
              (Math.log(_e(2, m)) / Math.LN10 * 2 + 5) |
              0), (l += n), (r = o = u = new d(1)), (d.precision = l);
            ;

          ) {
            if (
              ((o = f(o.times(e), l, 1)), (r = r.times(++h)), (c = u.plus(
                Le(o, r, l, 1)
              )), a(c.d).slice(0, l) === a(u.d).slice(0, l))
            ) {
              for (i = m; i--; )
                u = f(u.times(u), l, 1);
              if (null != t) return (d.precision = v), u;
              if (!(p < 3 && s(u.d, l - n, g, p)))
                return f(u, (d.precision = v), g, (Ne = !0));
        ...
        function b(e, t) {
          ...
          if (
            (null == t
              ? ((Ne = !1), (m = M))
              : (m = t), (N.precision = m += y), (r = a(w)), (n = r.charAt(
              0
            )), !(Math.abs((o = x.e)) < 15e14))
          )
            return (p = h(N, m + 2, M).times(o + '')), (x = b(
              new N(n + '.' + r.slice(1)),
              m - y
            ).plus(p)), (N.precision = M), null == t
              ? f(x, M, E, (Ne = !0))
              : x;
          ...
          for (
            (o = x.e), n > 1
              ? ((x = new N('0.' + r)), o++)
              : (x = new N(n + '.' + r.slice(1))), (d = x), (l = u = x = Le(
              x.minus(1),
              x.plus(1),
              m,
              1
            )), (g = f(x.times(x), m, 1)), (i = 3);
            ;

          ) {
            if (
              ((u = f(u.times(g), m, 1)), (p = l.plus(
                Le(u, new N(i), m, 1)
              )), a(p.d).slice(0, m) === a(l.d).slice(0, m))
            ) {
              if (
                ((l = l.times(2)), 0 !== o &&
                  (l = l.plus(h(N, m + 2, M).times(o + ''))), (l = Le(
                  l,
                  new N(v),
                  m,
                  1
              ...
              (N.precision = m += y), (p = u = x = Le(
                d.minus(1),
                d.plus(1),
                m,
                1
              )), (g = f(x.times(x), m, 1)), (i = c = 1);
            }
            (l = p), (i += 2);
          }
        }
        ...
        function E(e, t) {
          ...
          for (
            (r = t.indexOf('.')) > -1 &&
              (t = t.replace('.', '')), (n = t.search(/e/i)) > 0
              ? (r < 0 && (r = n), (r += +t.slice(n + 1)), (t = t.substring(
                  0,
                  n
                )))
              : r < 0 && (r = t.length), (n = 0);
        ...
        function M(e, t) {
          ...
          for (
            (a = t.search(/p/i)), a > 0
              ...
              : (t = t.slice(2)), (a = t.indexOf('.')), (o = a >= 0), (n =
              e.constructor), o &&
              ((t = t.replace('.', '')), (s = t.length), (a = s - a), (i = v(
                n,
                new n(r),
                a,
                2 * a
              ))), (f = u(t, r, Be)), (l = f.length - 1), (a = l);
            0 === f[a];
            --a
          )
            f.pop();
          return a < 0
            ? new n(0 * e.s)
            : ((e.e = p(f, l)), (e.d = f), (Ne = !1), o &&
                (e = Le(e, i, 4 * s)), c &&
                (e = e.times(
                  Math.abs(c) < 54 ? Math.pow(2, c) : be.pow(2, c)
                )), (Ne = !0), e);
        }
        function A(e, t) {
          var r, n = t.d.length;
          if (n < 3) return O(e, 2, t, t);
          (r = 1.4 * Math.sqrt(n)), (r = r > 16 ? 16 : 0 | r), (t = t.times(
            Math.pow(5, -r)
          )), (t = O(e, 2, t, t));
          for (var i, a = new e(5), o = new e(16), s = new e(20); r--; )
            (i = t.times(t)), (t = t.times(
              a.plus(i.times(o.times(i).minus(s)))
            ));
          return t;
        }
        function O(e, t, r, n, i) {
          ...
          for ((Ne = !1), (u = r.times(r)), (s = new e(n)); ; ) {
            if (
              ((o = Le(s.times(u), new e(t++ * t++), f, 1)), (s = i
                ? n.plus(o)
                : n.minus(o)), (n = Le(
                o.times(u),
                new e(t++ * t++),
        ...
        function T(e, t) {
          var r, n = t.s < 0, i = m(e, e.precision, 1), a = i.times(0.5);
        ...
        function _(e, t, r, n) {
          ...
          if (
            (v
              ? (o(r, 1, ve), void 0 === n ? (n = g.rounding) : o(n, 0, 8))
              : ((r = g.precision), (n = g.rounding)), e.isFinite())
          ) {
            for (
              (h = l(e)), (s = h.indexOf('.')), v
                ? ((i = 2), 16 == t
                    ...
                    : 8 == t && (r = 3 * r - 2))
                : (i = t), s >= 0 &&
                ((h = h.replace('.', '')), (d = new g(1)), (d.e =
                  h.length - s), (d.d = u(l(d), 10, i)), (d.e =
                  d.d.length)), (m = u(h, 10, i)), (a = f = m.length);
              0 == m[--f];
              ...
              if (
                (s < 0
                  ...
                  : ((e = new g(e)), (e.d = m), (e.e = a), (e = Le(
                      ...
                      0,
                      i
                    )), (m = e.d), (a = e.e), (p = me)), (s = m[r]), (c =
                  i / 2), (p = p || void 0 !== m[r + 1]), (p = n < 4
          ...
          return e.s && t.s
            ? e.d || t.d
                ? !t.d || e.isZero()
                    ...
                    : !e.d || t.isZero()
                        ? ((r = m(this, a, 1).times(0.5)), (r.s = e.s))
                        : t.s < 0
                            ? ((this.precision = a), (this.rounding = 1), (r = this.atan(
                                Le(e, t, a, 1)
                              )), (t = m(
                                this,
                                a,
                                1
                              )), (this.precision = n), (this.rounding = i), (r = e.s <
                                0
                                ? r.minus(t)
                                : r.plus(t)))
                            : (r = this.atan(Le(e, t, a, 1)))
                : ((r = m(this, a, 1).times(t.s > 0 ? 0.25 : 0.75)), (r.s =
                    e.s))
            : (r = new this(NaN)), r;
        }
        function L(e) {
        ...
        function G(e) {
          function t(e) {
            ...
            if (((a.constructor = t), e instanceof t))
              return (a.s = e.s), (a.e = e.e), void (a.d = (e = e.d)
                ? e.slice()
                : e);
        ...
        function ie(e) {
          ...
          if (
            (void 0 === e ? (e = this.precision) : o(e, 1, ve), (n = Math.ceil(
              e / Pe
            )), this.crypto)
          )
        ...
        (qe.absoluteValue = qe.abs = function() {
          ...
          return r.d
            ? r.d[0]
                ? ((e = n.precision), (t = n.rounding), (n.precision =
                    e + Math.max(r.e, r.sd()) + Pe), (n.rounding = 1), (r = c(
                    n,
                    T(n, r)
                  )), (n.precision = e), (n.rounding = t), f(
                    2 == de || 3 == de ? r.neg() : r,
                    e,
                    t,
                    !0
          ...
          for (
            (Ne = !1), (o = p.s * Math.pow(p.s * p, 1 / 3)), o &&
              Math.abs(o) != 1 / 0
              ? (n = new h(o.toString()))
              : ((r = a(p.d)), (e = p.e), (o = (e - r.length + 1) % 3) &&
                  (r += 1 == o || o == -2 ? '0' : '00'), (o = Math.pow(
                  r,
                  1 / 3
                )), (e = Te((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2))), o ==
                  1 / 0
                  ? (r = '5e' + e)
                  : ((r = o.toExponential()), (r =
                      r.slice(0, r.indexOf('e') + 1) + e)), (n = new h(
                  r
                )), (n.s = p.s)), (s = (e = h.precision) + 3);
            ;

          )
            if (
              ((u = n), (c = u.times(u).times(u)), (l = c.plus(p)), (n = Le(
                l.plus(p).times(u),
                l.plus(c),
                s + 2,
                1
              )), a(u.d).slice(0, s) === (r = a(n.d)).slice(0, s))
            ) {
              if (
                ((r = r.slice(s - 3, s + 1)), '9999' != r && (i || '4999' != r))
              ) {
          ...
          if (t) {
            if (
              ((e = t.length - 1), (r = (e - Te(this.e / Pe)) * Pe), (e = t[e]))
            )
              for (; e % 10 == 0; e /= 10)
                r--;
            r < 0 && (r = 0);
          ...
          (r = o.precision), (n = o.rounding), (o.precision =
            r + Math.max(a.e, a.sd()) + 4), (o.rounding = 1), (i =
            a.d.length), i < 32
            ? ((e = Math.ceil(i / 3)), (t = Math.pow(4, -e).toString()))
            : ((e = 16), (t = '2.3283064365386962890625e-10')), (a = O(
            o,
            1,
            a.times(t),
            new o(1),
          ...
          if (
            ((t = a.precision), (r = a.rounding), (a.precision =
              t + Math.max(i.e, i.sd()) + 4), (a.rounding = 1), (n =
              i.d.length), n < 3)
          )
            i = O(a, 2, i, i, !0);
          else {
            (e = 1.4 * Math.sqrt(n)), (e = e > 16 ? 16 : 0 | e), (i = i.times(
              Math.pow(5, -e)
            )), (i = O(a, 2, i, i, !0));
            for (var o, s = new a(5), u = new a(16), c = new a(20); e--; )
              (o = i.times(i)), (i = i.times(
                s.plus(o.times(u.times(o).plus(c)))
              ));
          }
          ...
          var e,
            ...
            a = r.rounding;
          return n !== -1
            ? 0 === n ? (t.isNeg() ? m(r, i, a) : new r(0)) : new r(NaN)
            : t.isZero()
                ? m(r, i + 4, a).times(0.5)
                : ((r.precision =
                    i + 6), (r.rounding = 1), (t = t.asin()), (e = m(
                    r,
                    i + 4,
                    a
                  ).times(0.5)), (r.precision = i), (r.rounding = a), e.minus(
                    t
                  ));
          ...
          return r.lte(1)
            ...
            : r.isFinite()
                ? ((e = n.precision), (t = n.rounding), (n.precision =
                    e +
                    Math.max(Math.abs(r.e), r.sd()) +
                    4), (n.rounding = 1), (Ne = !1), (r = r
                    .times(r)
                    .minus(1)
                    .sqrt()
                    .plus(
                      r
                    )), (Ne = !0), (n.precision = e), (n.rounding = t), r.ln())
                : new n(r);
          ...
          return !r.isFinite() || r.isZero()
            ...
            : ((e = n.precision), (t = n.rounding), (n.precision =
                e +
                2 * Math.max(Math.abs(r.e), r.sd()) +
                6), (n.rounding = 1), (Ne = !1), (r = r
                .times(r)
                .plus(1)
                .sqrt()
                .plus(
          ...
          return i.isFinite()
            ? i.e >= 0
                ...
                : ((e = a.precision), (t = a.rounding), (n = i.sd()), Math.max(
                    n,
                    e
                  ) <
                    2 * -i.e - 1
                    ? f(new a(i), e, t, !0)
                    : ((a.precision = r = n - i.e), (i = Le(
                        i.plus(1),
                        new a(1).minus(i),
                        r + e,
                        1
                        ...
                        e +
                        4), (a.rounding = 1), (i = i.ln()), (a.precision = e), (a.rounding = t), i.times(
                        0.5
                      )))
            : new a(NaN);
          ...
          return i.isZero()
            ? new a(i)
            : ((t = i.abs().cmp(1)), (r = a.precision), (n = a.rounding), t !==
                -1
                ? 0 === t
                    ? ((e = m(a, r + 4, n).times(0.5)), (e.s = i.s), e)
                    : new a(NaN)
                : ((a.precision = r + 6), (a.rounding = 1), (i = i
                    .div(new a(1).minus(i.times(i)).sqrt().plus(1))
                    .atan()), (a.precision = r), (a.rounding = n), i.times(2)));
          ...
          if (c.isFinite()) {
            ...
            if (c.abs().eq(1) && p + 4 <= Ue)
              return (o = m(l, p + 4, h).times(0.25)), (o.s = c.s), o;
          } else {
            if (!c.s) return new l(NaN);
            if (p + 4 <= Ue)
              return (o = m(l, p + 4, h).times(0.5)), (o.s = c.s), o;
          }
          for (
            (l.precision = s = p + 10), (l.rounding = 1), (r = Math.min(
              28,
              (s / Pe + 2) | 0
            )), (e = r);
            e;
          ...
          for (
            (Ne = !1), (t = Math.ceil(s / Pe)), (n = 1), (u = c.times(
              c
            )), (o = new l(c)), (i = c);
            e !== -1;
            ...
            if (
              ((i = i.times(u)), (a = o.minus(i.div((n += 2)))), (i = i.times(
                u
              )), (o = a.plus(i.div((n += 2)))), void 0 !== o.d[t])
            )
              for (e = t; o.d[e] === a.d[e] && e--; );
          return r && (o = o.times(2 << (r - 1))), (Ne = !0), f(
            o,
            (l.precision = p),
            (l.rounding = h),
            !0
          ...
          if (
            ((Ne = !1), (c = d + v), (u = b(p, c)), (n = t
              ? h(m, c + 10)
              : b(e, c)), (l = Le(u, n, c, 1)), s(l.d, (i = d), g))
          )
            do
              if (
                ((c += 10), (u = b(p, c)), (n = t
                  ? h(m, c + 10)
                  : b(e, c)), (l = Le(u, n, c, 1)), !o)
              ) {
                +a(l.d).slice(i + 1, i + 15) + 1 == 1e14 &&
                  (l = f(l, d + 1, 0));
                break;
              }
            while (s(l.d, (i += 10), g));
          ...
          if (((e = new g(e)), !d.d || !e.d))
            return d.s && e.s
              ? d.d ? (e.s = -e.s) : (e = new g(e.d || d.s !== e.s ? d : NaN))
              : (e = new g(NaN)), e;
          if (d.s != e.s) return (e.s = -e.s), d.plus(e);
          if (
            ((c = d.d), (m = e.d), (s = g.precision), (u = g.rounding), !c[0] ||
              !m[0])
          ) {
            if (m[0]) e.s = -e.s;
            else {
          ...
          if (
            ((r = Te(e.e / Pe)), (l = Te(d.e / Pe)), (c = c.slice()), (a =
              l - r))
          ) {
            for (
              (h = a < 0), h
                ? ((t = c), (a = -a), (o = m.length))
                : ((t = m), (r = l), (o = c.length)), (n =
                Math.max(Math.ceil(s / Pe), o) + 2), a > n &&
                ((a = n), (t.length = 1)), t.reverse(), (n = a);
              n--;
          ...
          for (
            h && ((t = c), (c = m), (m = t), (e.s = -e.s)), (o = c.length), (n =
              m.length - o);
            n > 0;
            --n
          )
          ...
          for (; 0 === c[0]; c.shift())
            --r;
          return c[0]
            ? ((e.d = c), (e.e = p(c, r)), Ne ? f(e, s, u) : e)
            : new g(3 === u ? -0 : 0);
        }), (qe.modulo = qe.mod = function(e) {
          var t, r = this, n = r.constructor;
          return (e = new n(e)), !r.d || !e.s || (e.d && !e.d[0])
            ? new n(NaN)
            : !e.d || (r.d && !r.d[0])
                ? f(new n(r), n.precision, n.rounding)
                : ((Ne = !1), 9 == n.modulo
                    ? ((t = Le(r, e.abs(), 0, 3, 1)), (t.s *= e.s))
                    : (t = Le(r, e, 0, n.modulo, 1)), (t = t.times(
                    e
                  )), (Ne = !0), r.minus(t));
          ...
          if (((e = new m(e)), !h.d || !e.d))
            return h.s && e.s
              ? h.d || (e = new m(e.d || h.s === e.s ? h : NaN))
              : (e = new m(NaN)), e;
          if (h.s != e.s) return (e.s = -e.s), h.minus(e);
          if (
            ((c = h.d), (l = e.d), (s = m.precision), (u = m.rounding), !c[0] ||
              !l[0])
          )
            return l[0] || (e = new m(h)), Ne ? f(e, s, u) : e;
          if (
            ((a = Te(h.e / Pe)), (n = Te(e.e / Pe)), (c = c.slice()), (i =
              a - n))
          ) {
            for (
              i < 0
                ? ((r = c), (i = -i), (o = l.length))
                : ((r = l), (n = a), (o = c.length)), (a = Math.ceil(
                s / Pe
              )), (o = a > o ? a + 1 : o + 1), i > o &&
                ((i = o), (r.length = 1)), r.reverse();
              i--;
          ...
          return r.isFinite()
            ? r.isZero()
                ? new n(r)
                : ((e = n.precision), (t = n.rounding), (n.precision =
                    e + Math.max(r.e, r.sd()) + Pe), (n.rounding = 1), (r = A(
                    n,
                    T(n, r)
                  )), (n.precision = e), (n.rounding = t), f(
                    de > 2 ? r.neg() : r,
          ...
          for (
            (Ne = !1), (l = Math.sqrt(+s)), 0 == l || l == 1 / 0
              ? ((t = a(u)), (t.length + c) % 2 == 0 &&
                  (t += '0'), (l = Math.sqrt(t)), (c =
                  Te((c + 1) / 2) - (c < 0 || c % 2)), l == 1 / 0
                  ? (t = '1e' + c)
                  : ((t = l.toExponential()), (t =
                      t.slice(0, t.indexOf('e') + 1) + c)), (n = new p(t)))
              : (n = new p(l.toString())), (r = (c = p.precision) + 3);
            ;

          )
            if (
              ((o = n), (n = o.plus(Le(s, o, r + 2, 1)).times(0.5)), a(
                o.d
              ).slice(0, r) === (t = a(n.d)).slice(0, r))
            ) {
              if (
                ((t = t.slice(r - 3, r + 1)), '9999' != t && (i || '4999' != t))
              ) {
          ...
          return r.isFinite()
            ? r.isZero()
                ...
                : ((e = n.precision), (t = n.rounding), (n.precision =
                    e +
                    10), (n.rounding = 1), (r = r.sin()), (r.s = 1), (r = Le(
                    r,
                    new n(1).minus(r.times(r)).sqrt(),
                    e + 10,
                    0
                  )), (n.precision = e), (n.rounding = t), f(
                    2 == de || 4 == de ? r.neg() : r,
          ...
          for (
            (r = Te(l.e / Pe) + Te(e.e / Pe)), (u = m.length), (c =
              d.length), u < c &&
              ((a = m), (m = d), (d = a), (o = u), (u = c), (c = o)), (a = []), (o =
              u + c), (n = o);
            n--;
          ...
          for (n = c; --n >= 0; ) {
            for ((t = 0), (i = u + n); i > n; )
              (s = a[i] + d[n] * m[i - n - 1] + t), (a[i--] =
                (s % Be) | 0), (t = (s / Be) | 0);
            a[i] = ((a[i] + t) % Be) | 0;
          }
          for (; !a[--o]; )
            a.pop();
          return t ? ++r : a.shift(), (e.d = a), (e.e = p(a, r)), Ne
            ? f(e, h.precision, h.rounding)
            : e;
          ...
          return (r = new n(r)), void 0 === e
            ? r
            : (o(e, 0, ve), void 0 === t ? (t = n.rounding) : o(t, 0, 8), f(
                r,
                e + r.e + 1,
                t
              ));
          ...
          return void 0 === e
            ...
            : (o(e, 0, ve), void 0 === t
                ? (t = a.rounding)
                : o(t, 0, 8), (n = f(new a(i), e + i.e + 1, t)), (r = l(
                n,
                !1,
                e + n.e + 1
          ...
          if (!g) return new v(m);
          if (
            ((f = r = new v(1)), (n = c = new v(0)), (t = new v(n)), (o = t.e =
              d(g) - m.e - 1), (s = o % Pe), (t.d[0] = _e(
              10,
              s < 0 ? Pe + s : s
            )), null == e)
          )
          ...
          for (
            (Ne = !1), (u = new v(a(g))), (l = v.precision), (v.precision = o =
              g.length * Pe * 2);
            (p = Le(u, t, 0, 1, 1)), (i = r.plus(p.times(n))), 1 != i.cmp(e);

          )
            (r = n), (n = i), (i = f), (f = c.plus(
              p.times(i)
            )), (c = i), (i = t), (t = u.minus(p.times(i))), (u = i);
          return (i = Le(e.minus(r), n, 0, 1, 1)), (c = c.plus(
            i.times(f)
          )), (r = r.plus(i.times(n))), (c.s = f.s = m.s), (h = Le(f, n, o, 1)
            .minus(m)
            .abs()
            .cmp(Le(c, r, o, 1).minus(m).abs()) < 1
            ? [f, n]
            : [c, r]), (v.precision = l), (Ne = !0), h;
          ...
          if (
            ((t = Te(e.e / Pe)), (r = e.d.length - 1), (c = t >= r), (u =
              l.s), c)
          ) {
            if ((r = h < 0 ? -h : h) <= Ie)
              return (i = v(p, l, r, n)), e.s < 0
                ? new p(1).div(i)
                : f(i, n, o);
          } else if (u < 0) return new p(NaN);
          return (u = u < 0 && 1 & e.d[Math.max(t, r)] ? -1 : 1), (r = _e(
            +l,
            h
          )), (t = 0 != r && isFinite(r)
            ? new p(r + '').e
            : Te(h * (Math.log('0.' + a(l.d)) / Math.LN10 + l.e + 1))), t >
            p.maxE + 1 || t < p.minE - 1
            ? new p(t > 0 ? u / 0 : 0)
            : ((Ne = !1), (p.rounding = l.s = 1), (r = Math.min(
                12,
                (t + '').length
              )), (i = w(e.times(b(l, n + r)), n)), (i = f(i, n + 5, 1)), s(
                i.d,
                n,
                o
              ) &&
                ((t = n + 10), (i = f(
                  ...
                  t + 5,
                  1
                )), +a(i.d).slice(n + 1, n + 15) + 1 == 1e14 &&
                  (i = f(
                    i,
                    n + 1,
                    0
                  ))), (i.s = u), (Ne = !0), (p.rounding = o), f(i, n, o));
          ...
          return void 0 === e
            ...
            : (o(e, 1, ve), void 0 === t ? (t = n.rounding) : o(t, 0, 8)), f(
            new n(r),
            e,
            t
          );
        ...
        var Le = (function() {
          ...
          return function(n, i, a, o, s, u) {
            ...
            for (
              u
                ? ((m = 1), (l = n.e - i.e))
                : ((u = Be), (m = Pe), (l = Te(n.e / m) - Te(i.e / m))), (_ =
                B.length), (O = k.length), (y = new C(
                z
              )), (x = y.d = []), (p = 0);
              B[p] == (k[p] || 0);
              p++
            ...
            if (
              (B[p] > (k[p] || 0) && l--, null == a
                ? ((E = a = C.precision), (o = C.rounding))
                : (E = s ? a + (n.e - i.e) + 1 : a), E < 0)
            )
              x.push(1), (d = !0);
            else {
              if (((E = (E / m + 2) | 0), (p = 0), 1 == _)) {
                for ((h = 0), (B = B[0]), E++; (p < O || h) && E--; p++)
                  (M = h * u + (k[p] || 0)), (x[p] = (M / B) | 0), (h =
                    (M % B) | 0);
                d = h || p < O;
              } else {
                for (
                  (h = (u / (B[0] + 1)) | 0), h > 1 &&
                    ((B = e(B, h, u)), (k = e(k, h, u)), (_ = B.length), (O =
                      k.length)), (A = _), (w = k.slice(0, _)), (b = w.length);
                  b < _;
                ...
                do
                  (h = 0), (c = t(B, w, _, b)), c < 0
                    ? ((N = w[0]), _ != b && (N = N * u + (w[1] || 0)), (h =
                        (N / T) | 0), h > 1
                        ? (h >= u && (h = u - 1), (g = e(B, h, u)), (v =
                            g.length), (b = w.length), (c = t(g, w, v, b)), 1 ==
                            c && (h--, r(g, _ < v ? S : B, v, u)))
                        : (0 == h && (c = h = 1), (g = B.slice())), (v =
                        g.length), v < b && g.unshift(0), r(w, g, b, u), c ==
                        -1 &&
                        ((b = w.length), (c = t(B, w, _, b)), c < 1 &&
                          (h++, r(w, _ < b ? S : B, b, u))), (b = w.length))
                    : 0 === c && (h++, (w = [0])), (x[p++] = h), c && w[0]
                    ? (w[b++] = k[A] || 0)
                    : ((w = [k[A]]), (b = 1));
 ...
 **/
      !(function(r) {
        ...
        function a(e) {
          var t = function() {
            ...
            (t.name = this.name = e), (this.stack = t.stack), (this.message =
              t.message);
          },
            r = function() {};
        ...
        function u(e, t) {
          return this instanceof u
            ? (h(e, t), (e = u.REDUCE ? v(f.d, f.n) : 1), (this.s =
                f.s), (this.n = f.n / e), void (this.d = f.d / e))
            : new u(e, t);
        }
        var c = 2e3,
          f = { s: 1, n: 0, d: 1 },
                    ...
                    ((g = e.match(/\d+|./g)), '-' === g[d]
                      ...
                      : '.' === g[d + 1] || '.' === g[d]
                          ? ('.' !== g[d] && (u = o(g[d++], a)), d++, (d + 1 ===
                              ...
                              ('(' === g[d + 1] && ')' === g[d + 3]) ||
                              ("'" === g[d + 1] && "'" === g[d + 3])) &&
                              ((c = o(g[d], a)), (h = Math.pow(
                                10,
                                g[d].length
                              )), d++), (('(' === g[d] && ')' === g[d + 2]) ||
                              ("'" === g[d] && "'" === g[d + 2])) &&
                              ((p = o(g[d + 1], a)), (m =
                                Math.pow(10, g[d + 1].length) - 1), (d += 3)))
                          : '/' === g[d + 1] || ':' === g[d + 1]
                              ? ((c = o(g[d], a)), (h = o(
                                  g[d + 2],
                                  1
        ...
        (u.REDUCE = 1), (u.prototype = {
          ...
          add: function(e, t) {
            return h(e, t), new u(
              this.s * this.n * f.d + f.s * this.d * f.n,
              this.d * f.d
            );
          },
          sub: function(e, t) {
          ...
          mod: function(e, t) {
            return isNaN(this.n) || isNaN(this.d)
              ...
              : void 0 === e
                  ...
                  : (h(e, t), 0 === f.n && 0 === this.d && u(0, 0), new u(
                      this.s * f.d * this.n % (f.n * this.d),
                      f.d * this.d
                    ));
          },
          gcd: function(e, t) {
            return h(e, t), new u(
              v(f.n, this.n),
              f.d * this.d / v(f.d, this.d)
            );
          },
          lcm: function(e, t) {
            return h(e, t), 0 === f.n && 0 === this.n
              ? new u()
              : new u(f.n * this.n / v(f.n, this.n), v(f.d, this.d));
          },
          ceil: function(e) {
            return (e = Math.pow(10, e || 0)), isNaN(this.n) || isNaN(this.d)
              ? new u(NaN)
          ...
          toLatex: function(e) {
            ...
            return this.s < 0 && (r += '-'), 1 === i
              ? (r += n)
              : (e && (t = Math.floor(n / i)) > 0 && ((r += t), (n %= i)), (r +=
                  '\\frac{'), (r += n), (r += '}{'), (r += i), (r += '}')), r;
          },
    ...
    function(e, t, r) {
      ...
      (function(t) {
        ...
        (e.exports = function(t, c) {
          if (c && c.global === !0)
            return (c.global = !1), (Math.random = e.exports(
              t,
              c
            )), (c.global = !0), Math.random;
          var l = (c && c.entropy) || !1,
            d = [],
            g = (i(n(l ? [t, o(f)] : 0 in arguments ? t : a(), 3), d), new r(
              d
            ));
    ...
    function(e, t, r) {
      ...
      var n, i, a;
      !(function(r, o) {
        (i = []), (n = o), (a = 'function' == typeof n
          ? n.apply(t, i)
          : n), !(void 0 !== a && (e.exports = a));
      })(this, function() {
        function e() {
          function t(e) {
            ...
            if (!t) {
              ...
              for (r = 0; r < M.types.length; r++)
                if (
                  ((n = M.types[r]), n.name.toLowerCase() == e.toLowerCase())
                ) {
                  i = n.name;
                  break;
                }
          ...
          function o(e, t) {
            ...
            (this.params = new Array(
              r.length
            )), (this.anyType = !1), (this.varArgs = !1);
            for (var n = 0; n < r.length; n++) {
              var i = new a(r[n]);
              if (
                ((this.params[n] = i), i.anyType && (this.anyType = !0), n ===
                  r.length - 1)
              )
          ...
          function u(e) {
            ...
            for (
              ...
              r++
                ...
                for (
                  var h = t.params.length - 1, m = t.params[h], d = 0;
                  d < m.types.length;
          ...
          function l(e, t, r) {
            ...
            for (n = 0; n < c.length; n++) {
              ...
              if (h) {
                if (h.param.varArgs)
                  throw new Error(
                    'Conflicting types "' + h.param + '" and "' + p + '"'
                  );
                h.signatures.push(i);
          ...
          function h(e, t) {
            ...
            h.push(
              'function ' + d + '(' + g.join(', ') + ') {'
            ), h.push('  "use strict";'), h.push("  var name = '" + d + "';"), h.push(s.toCode(r, '  ', !1)), h.push('}');
          ...
          (i.prototype.add = function(e, t) {
            ...
            return n == -1 &&
              ((n = this.categories[r].length), this.categories[r].push(e)), r +
              n;
              ...
              if (n.length < r.params.length) {
                ...
                if (c.varArgs) {
                  for ((s = c.clone()), (i = 0); i < M.conversions.length; i++)
                    if (
                      ((u = M.conversions[i]), !g(c.types, u.from) &&
                        g(c.types, u.to))
                    ) {
                  ...
                  for (i = 0; i < M.conversions.length; i++)
                    (u = M.conversions[i]), !g(c.types, u.from) &&
                      g(c.types, u.to) &&
                      ((s = new a(u.from)), (s.conversions[0] = u), e(
                        r,
                        n.concat(s)
                      ));
                }
            ...
            for (r = 0; r < n; r++)
              e.params[r].hasConversions() && i++, t.params[
                r
              ].hasConversions() && o++;
            if (i > o) return 1;
            if (i < o) return -1;
            ...
            if (this.param) {
              var i = this.path.length - 1,
                ...
                o =
                  '// type: ' +
                  (a ? a.from + ' (convert to ' + a.to + ')' : this.param);
              if (this.param.varArgs)
                if (this.param.anyType)
                  n.push(r + 'if (arguments.length > ' + i + ') {'), n.push(
                    r + '  var varArgs = [];'
                  ), n.push(
                    r + '  for (var i = ' + i + '; i < arguments.length; i++) {'
                  ), n.push(r + '    varArgs.push(arguments[i]);'), n.push(
                    r + '  }'
                  ), n.push(this.signature.toCode(e, r + '  ')), n.push(
                    r + '}'
                  );
                else {
                  for (
                  ...
                  n.push(r + 'if (' + s(u, 'arg' + i) + ') { ' + o), n.push(
                    r + '  var varArgs = [arg' + i + '];'
                  ), n.push(
                    r +
                      '  for (var i = ' +
                  ...
                  for (var f = 0; f < u.length; f++) {
                    ...
                    if (l) {
                      ...
                      n.push(r + '    }'), n.push(
                        r + '    else if (' + p + '(arguments[i])) {'
                      ), n.push(
                        r + '      varArgs.push(' + h + '(arguments[i]));'
                      );
                    }
                  }
                  n.push(r + '    } else {'), n.push(
                    r +
                      "      throw createError(name, arguments.length, i, arguments[i], '" +
                      c.join(',') +
                      "');"
                  ), n.push(r + '    }'), n.push(r + '  }'), n.push(
                    this.signature.toCode(e, r + '  ')
                  ), n.push(r + '}');
                }
            ...
            for (
              this.signature &&
                ...
                ), n.push(this.signature.toCode(e, t + '  ')), n.push(
                  t + '}'
                )), (r = 0);
              r < this.childs.length;
              r++
            )
          ...
          var w = [
            ...
            N = [],
            E = [],
            M = { config: b, types: w, conversions: N, ignore: E };
          return (M = h('typed', {
            Object: function(e) {
              var t = [];
              for (var n in e)
                  ...
                  if (o.signatures.hasOwnProperty(s))
                    if (i.hasOwnProperty(s)) {
                      if (o.signatures[s] !== i[s])
                        ...
                        )), (t.data = { signature: s }), t);
                    } else i[s] = o.signatures[s];
              }
              return h(n, i);
            },
          })), (M.config = b), (M.types = w), (M.conversions = N), (M.ignore = E), (M.create = e), (M.find = y), (M.convert = x), (M.addType = function(
            e
          ) {
